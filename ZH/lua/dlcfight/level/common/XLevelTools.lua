...
function XLevelTools.BasicFightUIControl(proxy, enable)
    ...
    proxy:SetUiWidgetActive(EUiIndex.FightControl, EUiFightWidgetKey.Joystick, enable)
    proxy:SetUiWidgetActive(EUiIndex.FightControl, EUiFightWidgetKey.BtnAttack, enable)
    proxy:SetUiWidgetActive(EUiIndex.FightControl, EUiFightWidgetKey.BtnDodge, enable)
    --proxy:SetUiWidgetActive(EUiIndex.FightControl, EUiFightWidgetKey.BtnExSkill,  enable)
    proxy:SetUiWidgetActive(EUiIndex.FightControl, EUiFightWidgetKey.BtnJump, enable)
    proxy:SetUiWidgetActive(EUiIndex.FightControl, EUiFightWidgetKey.BtnSpear, enable)
    proxy:SetUiWidgetActive(EUiIndex.FightControl, EUiFightWidgetKey.BtnFocus, enable)

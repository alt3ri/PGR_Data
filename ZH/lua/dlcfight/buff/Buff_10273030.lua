...
---@class XBuffScript10273030 : XTheatre6SkillBase
local XBuffScript10273030 = XDlcScriptManager.RegBuffScript(10273030, "XBuffScript10273030", XTheatre6SkillBase)

--效果说明：
--· 【拼刀】属性>230点时，伤害额外提高100%攻击。
--· 造成3秒【晕眩】。

function XBuffScript10273030:ScriptInit(isGainControl) --初始化
    self.TargetSkill = self._skillId
    self._damageMagicId = 10270178 --注册拼刀成功技3伤害id
...
function XBuffScript10273030:InitEventCallBackRegister()
    --按需求解除注释进行注册
    self._proxy:RegisterEventByTarget(EWorldEvent.NpcCalcDamageBefore, self._npcUUID)
end

function XBuffScript10273030:OnLuaSkillStart(eventArgs)
...
function XBuffScript10273030:BeforeDamageCalc(eventArgs)

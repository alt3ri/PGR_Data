...
---@class XBuffScript10265020 : XTheatre6SkillBase
local XBuffScript10265020 = XDlcScriptManager.RegBuffScript(10265020, "XBuffScript10265020", XTheatre6SkillBase)

--效果说明：
--· 【超算】属性>230点时，伤害额外提高20/25/30%攻击。

function XBuffScript10265020:ScriptInit(isGainControl) --初始化
...
function XBuffScript10265020:OnLuaSkillStart(eventArgs)
    ------------执行------------
...
function XBuffScript10265020:InitEventCallBackRegister()
    --按需求解除注释进行注册
    self._proxy:RegisterEventByTarget(EWorldEvent.NpcCalcDamageBefore, self._npcUUID)
end

function XBuffScript10265020:ChangeDamageBeforeCalc(eventArgs)

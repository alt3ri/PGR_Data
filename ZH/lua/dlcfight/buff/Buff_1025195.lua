...
---@class XBuffScript1025195 : XTheatre6SkillBase
local XBuffScript1025195 = XDlcScriptManager.RegBuffScript(1025195, "XBuffScript1025195", XTheatre6SkillBase)


--效果说明：进入战斗时，损失10%生命值

function XBuffScript1025195:Init()
    --初始化
    ...
    ------------执行------------
    self.dmgRatio = 0.15 --损失生命值比例
end

function XBuffScript1025195:InitEventCallBackRegister()
    --按需求解除注释进行注册
...
function XBuffScript1025195:OnNpcAddBuffEvent(casterNpcUUID, npcUUID, buffId, buffKinds, buffUUId)
...
function XBuffScript1025195:AfterDamageCalc(eventArgs)

...
---@class XBuffScript1025195 : XTheatre6BuffBase
local XBuffScript1025195 = XDlcScriptManager.RegBuffScript(1025195, "XBuffScript1025195", XTheatre6BuffBase)
...
function XBuffScript1025195:Update(dt)

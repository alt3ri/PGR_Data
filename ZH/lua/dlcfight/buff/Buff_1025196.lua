...
---@class XBuffScript1025196 : XTheatre6SkillBase
local XBuffScript1025196 = XDlcScriptManager.RegBuffScript(1025196, "XBuffScript1025196", XTheatre6SkillBase)


--效果说明：进入战斗时，损失20%生命值

function XBuffScript1025196:Init()
    --初始化
    ...
    ------------执行------------
    self.dmgRatio = 0.3 --损失生命值比例
end

function XBuffScript1025196:InitEventCallBackRegister()
    --按需求解除注释进行注册
...
function XBuffScript1025196:OnNpcAddBuffEvent(casterNpcUUID, npcUUID, buffId, buffKinds, buffUUId)
...
function XBuffScript1025196:AfterDamageCalc(eventArgs)

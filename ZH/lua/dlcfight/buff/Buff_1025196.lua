...
---@class XBuffScript1025196 : XTheatre6BuffBase
local XBuffScript1025196 = XDlcScriptManager.RegBuffScript(1025196, "XBuffScript1025196", XTheatre6BuffBase)
...
function XBuffScript1025196:Update(dt)

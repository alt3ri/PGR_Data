...
---@class XBuffScript1025311 : XBuffBase
local XBuffScript1025311 = XDlcScriptManager.RegBuffScript(1025311, "XBuffScript1025311", Base)
...
function XBuffScript1025311:Init()
    ...
    self._proxy:ApplyMagic(self._uuid, self._uuid, 1025904,1,0, self.originAttrib2)
end

function XBuffScript1025311:Update(dt)
    --每帧执行
    Base.Update(self, dt)
    ------------执行------------
...
function XBuffScript1025311:OnNpcAddBuffEvent(casterNpcUUID, npcUUID, buffId, buffKinds, buffUUId)

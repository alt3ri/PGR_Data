...
XTheatre6AngerController.HitAffixTag = XGameplayTag.Missile_Theatre6_HitAffixType_Anger
...
function XTheatre6AngerController:OnLuaSkillEnd(eventArgs)
    ...
    ------------执行------------
    self.originAttrib1 = self._proxy:GetBuffStacks( self._enemyUUID,self.StackBuffAngry)
    if self.originAttrib1 >= 1 then
        ...
        self.originAttrib2 = self._proxy:GetBuffStacks( self._enemyUUID,self.StackBuffAnger)

...
XPersonalInfoManagerCreator = function()
    ...
    function XPersonalInfoManager.ReqShowInfoPanel(id, loadCompleteCB, closeCB, chatContent, openViewCb)--查看个人信息
    ...
    --增加管理对象
    function XPersonalInfoManager.AddPanelPersonalInfo()
    ...
    function XPersonalInfoManager.CreateItems(rootUi, item, parent, pageNum, id, selType, callback)
        ...
        local pool = selType == XPersonalInfoManager.ItemPanelType.DailyleaveMsg
                    and XPersonalInfoManager.GetPool(XPlayer.Id == PlayerData.Id
                    and DailyItemsPools or OtherDailyItemsPools, tonumber(pageNum .. id))
                    or XPersonalInfoManager.GetPool(XPlayer.Id == PlayerData.Id
                    and DailyItemsPools or OtherDailyItemsPools, pageNum)
        local datas = selType == XPersonalInfoManager.ItemPanelType.DailyleaveMsg
                    and GetLeaveMsgsById(pageNum, id)
                    or XPersonalInfoManager.GetPool(DailyServerDataPools, pageNum)

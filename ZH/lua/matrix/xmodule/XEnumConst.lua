XEnumConst = {
    ...
    FangKuai = {
        ...
        FeverState = {
            ...
            OperateUp = 2, -- 操作方块上升
            UseItemUp = 3, -- 使用道具上升
            UltimaSlash = 4, -- 使用真意斩道具
            ExitDown = 5, -- 退出狂热状态下降
            EnterFevUp = 6, -- 进入狂热状态时方块上升速度改变
            ExitFevDown = 7, -- 退出狂热状态时方块下降速度改变
            PlayLineUp = 8, -- 预览线上升
            PlayLineDown = 9, -- 预览线下降
            ForbidUp = 10, -- 强化拖动后屏蔽棋盘上升
    ...
    TeamTypeId = {
        ...
        Escape = 120,
        TwoSideTower = 130,
        Unknown1 = 140, --这3个不知道加在了哪里
        Unknown2 = 150, --这3个不知道加在了哪里

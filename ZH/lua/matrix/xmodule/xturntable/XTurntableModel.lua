...
function XTurntableModel:GetSkipAnimationValue()
    return self._SaveUtil:GetData("TurntableJump")
end

function XTurntableModel:SaveSkipAnimationValue(value)
    self._SaveUtil:SaveData("TurntableJump", value)
end

...
--- 清除最近一次奖励列表缓存（BattleSettlement 显示后调，防连战残留致下次误显上局 reward）#reward残留
function XPunishaarControl:ClearLastRewardGoodsList()
    self._Model:ClearLastRewardGoodsList()
end

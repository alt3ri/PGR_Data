...
function XDlcWorld:GetMatchType()
    return self._Config.MatchType
end
...
function XDlcWorld:GetTeamPlayerLeast()
    return self._Config.TeamPlayerLeast
end

function XDlcWorld:GetTeamPlayerLimit()
    return self._Config.TeamPlayerLimit
end

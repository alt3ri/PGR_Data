...
function XPreloadAgency:DownloadPreloadIndex()
    if IsNewDownload then
        local preloadSha = CS.XRemoteConfig.PreloadSha
        local preloadSize = CS.XRemoteConfig.PreloadSize
        local originalPreloadSha = CS.XRemoteConfig.OriginalPreloadSha
        local originalPreloadSize = CS.XRemoteConfig.OriginalPreloadSize
        ...
        XLaunchConst.StartDownloadFile(function(downloadGroup)
            downloadGroup:AddTask(preloadStartUrl, preloadStartFilePath, preloadSize, preloadSha)
            downloadGroup:AddTask(preloadEndUrl, preloadEndFilePath, originalPreloadSize, originalPreloadSha)
        end, function()

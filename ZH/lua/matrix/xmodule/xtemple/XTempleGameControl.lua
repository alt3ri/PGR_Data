...
function XTempleGameControl:PlayMusicChangeTime()
    XLuaAudioManager.PlayAudioByType(XLuaAudioManager.SoundType.SFX, self._Model:GetMusicChangeTime())
end

function XTempleGameControl:PlayMusicSettle()
    XLuaAudioManager.PlayAudioByType(XLuaAudioManager.SoundType.SFX, self._Model:GetMusicSuccess())
end

function XTempleGameControl:PlayMusicInsertFail()
    XLuaAudioManager.PlayAudioByType(XLuaAudioManager.SoundType.SFX, self._Model:GetMusicFail())
end
...
function XTempleGameControl:PlayMusicScore(score)
    ...
    XLuaAudioManager.PlayAudioByType(XLuaAudioManager.SoundType.SFX, self._Model:GetMusicScore(score))
end

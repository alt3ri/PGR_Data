...
function XTheatre3Step:GetEquipBoxId()
    return self._EquipBoxId
end
...
--region Step - RefreshEquipBox

function XTheatre3Step:UpdateRefreshTimes(refreshTimes)
    self.RefreshTimes = refreshTimes
end

function XTheatre3Step:UpdateFreeRefreshLimit(freeRefreshLimit)
    self.FreeRefreshLimit = freeRefreshLimit
end

function XTheatre3Step:UpdateDiscount(discount)
    self.RefreshDiscount = discount
end

function XTheatre3Step:GetRefreshTimes()
    return self.RefreshTimes
end

function XTheatre3Step:GetFreeRefreshLimit()
    return self.FreeRefreshLimit
end

function XTheatre3Step:GetDiscount()
    return self.RefreshDiscount
end
...
function XTheatre3Step:NotifyData(data)
    ...
    -- 装备箱刷新
    self:UpdateRefreshTimes(data.RefreshTimes)
    self:UpdateFreeRefreshLimit(data.FreeRefreshLimit)
    self:UpdateDiscount(data.RefreshDiscount)
end

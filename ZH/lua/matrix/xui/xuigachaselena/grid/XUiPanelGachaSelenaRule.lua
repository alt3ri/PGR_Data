---@class XUiPanelGachaSelenaRule : XUiNode
---@field Parent XUiGachaSelenaLog
local XUiPanelGachaSelenaRule = XClass(XUiNode, "XUiPanelGachaSelenaRule")

function XUiPanelGachaSelenaRule:RefreshUiShow(gachaConfig)
...
return XUiPanelGachaSelenaRule
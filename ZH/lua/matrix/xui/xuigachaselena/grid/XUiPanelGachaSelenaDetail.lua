...
---@class XUiPanelGachaSelenaDetail : XUiNode
---@field Parent XUiGachaSelenaLog
local XUiPanelGachaSelenaDetail = XClass(XUiNode, "XUiPanelGachaSelenaDetail")

function XUiPanelGachaSelenaDetail:RefreshUiShow(gachaConfig)
    ...
    for _, v in ipairs(list) do
        ...
        gridIcon:SetCustomWeaopnFashionId(fashionId, XUiHelper.GetText("GachaSelenaFashionDesc"))
...
return XUiPanelGachaSelenaDetail
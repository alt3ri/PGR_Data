---@class XUiGridGachaSelenaStageItem : XUiNode
---@field Parent XUiGachaSelenaStageLine
local XUiGridGachaSelenaStageItem = XClass(XUiNode, "XUiGridGachaSelenaStageItem")

function XUiGridGachaSelenaStageItem:SetNormalStage()
...
function XUiGridGachaSelenaStageItem:SetPassStage()
    self.PanelStagePass.gameObject:SetActiveEx(self._FStage:GetIsPass())
end

function XUiGridGachaSelenaStageItem:UpdateNode(index, festivalId, stageId)
...
function XUiGridGachaSelenaStageItem:OnBtnStageClick()
...
function XUiGridGachaSelenaStageItem:SetNodeSelect(isSelect)
    if not self._IsLock and self.ImageSelected then
        self.ImageSelected.gameObject:SetActiveEx(isSelect)
    end
end

function XUiGridGachaSelenaStageItem:ResetItemPosition(pos)
    if self.ImgHideLine then
...
return XUiGridGachaSelenaStageItem
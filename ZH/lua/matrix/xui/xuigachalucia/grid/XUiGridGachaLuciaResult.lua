...
---@class XUiGridGachaLuciaResult : XUiNode
---@field Parent XUiGachaLuciaShow
local XUiGridGachaLuciaResult = XClass(XUiNode, "XUiGridGachaLuciaResult")

function XUiGridGachaLuciaResult:OnStart()
    self:InitUiObject()
end

function XUiGridGachaLuciaResult:InitUiObject()
...
function XUiGridGachaLuciaResult:SetData(rewardInfo)
...
function XUiGridGachaLuciaResult:LoadEffect(id)
...
function XUiGridGachaLuciaResult:SetBgRawImage(id)
...
return XUiGridGachaLuciaResult
...
---@class XUiPanelGachaLuciaReward : XUiNode
---@field Parent XUiGachaLuciaLog
local XUiPanelGachaLuciaReward = XClass(XUiNode, "XUiPanelGachaLuciaReward")

function XUiPanelGachaLuciaReward:RefreshUiShow(gachaConfig)
...
return XUiPanelGachaLuciaReward
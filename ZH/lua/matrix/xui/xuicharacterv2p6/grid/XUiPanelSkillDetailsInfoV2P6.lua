...
function XUiPanelSkillDetailsInfoV2P6:InitButton()
    ...
    XUiHelper.RegisterCommonClickEvent(self, self.BtnSwitch, self.OnBtnSwitchClick)
end
...
function XUiPanelSkillDetailsInfoV2P6:Refresh(skillGroupIndex)
    ...
    local skillGroupId = skillGroupIdList[skillGroupIndex]
    ...
    local isCanSwitch = skillGroup:GetLevel() > 0 and XMVCA.XCharacter:CanEnhanceSkillGroupSwitch(skillGroupId)
    self.BtnSwitch.gameObject:SetActiveEx(isCanSwitch)
...
function XUiPanelSkillDetailsInfoV2P6:OnBtnUnlockClick()
    ...
    self.CharacterAgency:UnlockEnhanceSkillRequest(self.SkillGroup:GetSkillGroupId(), self.CharacterId, function (newGeneralSkillTipCb)
        self.Parent:RefreshUiShow()
        XLuaUiManager.OpenWithCloseCallback("UiEnhanceSkillActivation", newGeneralSkillTipCb, self.SkillType, self.SkillGroup, self.CharacterId)
    end)
end
...
function XUiPanelSkillDetailsInfoV2P6:OnBtnSwitchClick()
    XLuaUiManager.Open("UiCharacterEnhacneSkillSwitch", self.SkillGroupId, self.SkillGroup, self.CharacterId, function ()
        self.Parent:RefreshUiShow()
    end)
end

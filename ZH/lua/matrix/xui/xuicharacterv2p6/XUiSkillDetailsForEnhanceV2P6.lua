...
---@param gridIndex 当前界面是第几个技能
function XUiSkillDetailsForEnhanceV2P6:OnStart(characterId, gridIndex)
...
function XUiSkillDetailsForEnhanceV2P6:RefreshUiShow()
    self:InitSkillBtn()
    local index = self.InitGridIndex or self.CurrentSkillSelect
    self.InitGridIndex = nil
    self.PanelTagGroup:SelectIndex(index or 1)

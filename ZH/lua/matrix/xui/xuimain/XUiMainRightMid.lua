...
--研发活动标签
--鬼泣五联动卡池【联动】标签
function XUiMainRightMid:CheckCollaborationTag()
    local devilMayCryTag = XUiHelper.TryGetComponent(self.BtnReward.transform, "Tab3", nil)
    devilMayCryTag.gameObject:SetActiveEx(XDataCenter.DrawManager.CheckCollaborationDrawOpen())
end

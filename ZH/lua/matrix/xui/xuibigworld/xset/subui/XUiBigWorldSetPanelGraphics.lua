...
function XUiBigWorldSetPanelGraphics:OnTGroupCharacterShadowClick(index)
    self._Setting:SetCharacterShadowLevel(index - 1)
    self:_RefreshAutoGroup()
end

function XUiBigWorldSetPanelGraphics:OnTGroupLightingQualityClick(index)
    self._Setting:SetLightingQualityLevel(index - 1)
    self:_RefreshAutoGroup()
end

function XUiBigWorldSetPanelGraphics:OnTGroupCharacterQualityClick(index)
    self._Setting:SetRoleQualityLevel(index - 1)
    self:_RefreshAutoGroup()
end

function XUiBigWorldSetPanelGraphics:OnTGroupSceneQualityClick(index)
    self._Setting:SetSceneQualityLevel(index - 1)
    self:_RefreshAutoGroup()
end

-- function XUiBigWorldSetPanelGraphics:OnTGroupRenderScaleClick(index)
--     self._Setting:SetRenderScaleLevel(index - 1)
--     self:_RefreshAutoGroup()
-- end
...
function XUiBigWorldSetPanelGraphics:_RegisterButtonClicks()
    ...
    self:_RegisterTGroupCharacterShadow()
    self:_RegisterTGroupLightingQuality()
...
function XUiBigWorldSetPanelGraphics:_RegisterTGroupCharacterShadow()
    self.TGroupCharacterShadow:Init(self._TogCharacterShadowGroup, Handler(self, self.OnTGroupCharacterShadowClick))
end

function XUiBigWorldSetPanelGraphics:_RegisterTGroupLightingQuality()
    self.TGroupLightingQuality:Init(self._TogLightingQualityGroup, Handler(self, self.OnTGroupLightingQualityClick))
end

function XUiBigWorldSetPanelGraphics:_RegisterTGroupCharacterQuality()
    self.TGroupCharacterQuality:Init(self._TogCharacterQualityGroup, Handler(self, self.OnTGroupCharacterQualityClick))
end

function XUiBigWorldSetPanelGraphics:_RegisterTGroupSceneQuality()
    self.TGroupSceneQuality:Init(self._TogSceneQualityGroup, Handler(self, self.OnTGroupSceneQualityClick))
end

-- function XUiBigWorldSetPanelGraphics:_RegisterTGroupRenderScale()
--     self.TGroupRenderScale:Init(self._TogRenderScaleGroup, Handler(self, self.OnTGroupRenderScaleClick))
-- end
...
function XUiBigWorldSetPanelGraphics:_RefreshOther()
    ...
    self:_RefreshTGroupCharacterShadow()
...
function XUiBigWorldSetPanelGraphics:_RefreshAutoGroup()
    ...
    index = math.min(index, #self._TogQualityGroup)
...
function XUiBigWorldSetPanelGraphics:_RefreshTGroupCharacterShadow()
    local level = self._Setting:GetCharacterShadowLevel()
    self.TGroupCharacterShadow:SelectIndex(level + 1, false)
end

function XUiBigWorldSetPanelGraphics:_RefreshTGroupLightingQuality()
    local level = self._Setting:GetLightingQualityLevel()
    self.TGroupLightingQuality:SelectIndex(level + 1, false)
end

function XUiBigWorldSetPanelGraphics:_RefreshTGroupCharacterQuality()
    local level = self._Setting:GetRoleQualityLevel()
    self.TGroupCharacterQuality:SelectIndex(level + 1, false)
end

function XUiBigWorldSetPanelGraphics:_RefreshTGroupSceneQuality()
    local level = self._Setting:GetSceneQualityLevel()
    self.TGroupSceneQuality:SelectIndex(level + 1, false)
end

-- function XUiBigWorldSetPanelGraphics:_RefreshTGroupRenderScale()
--     local level = self._Setting:GetRenderScaleLevel()
--     self.TGroupRenderScale:SelectIndex(level + 1, false)
-- end
...
function XUiBigWorldSetPanelGraphics:_InitTogGroup()
    ...
    self._TogCharacterShadowGroup = {
        self.TogCharacterShadow_1,
        self.TogCharacterShadow_2,
        self.TogCharacterShadow_3,
    }

    self._TogLightingQualityGroup = {
        self.TogLightingQuality_1,
        self.TogLightingQuality_2,
        self.TogLightingQuality_3,
        self.TogLightingQuality_4,
    }

    self._TogCharacterQualityGroup = {
        self.TogCharacterQuality_1,
        self.TogCharacterQuality_2,
        self.TogCharacterQuality_3,
    }

    self._TogSceneQualityGroup = {
        self.TogSceneQuality_1,
        self.TogSceneQuality_2,
        self.TogSceneQuality_3,
        self.TogSceneQuality_4,
    }

    self._TogRenderScaleGroup = {
        self.TogRenderScale_1,
        self.TogRenderScale_2,
        self.TogRenderScale_3,
        self.TogRenderScale_4,
        self.TogRenderScale_5,
    }
end

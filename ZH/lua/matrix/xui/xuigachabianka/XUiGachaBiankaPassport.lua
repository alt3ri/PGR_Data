---@class XUiGachaBiankaPassport : XLuaUi 使用皮肤和场景弹框
local XUiGachaBiankaPassport = XLuaUiManager.Register(XLuaUi, "UiGachaBianka402Passport")

function XUiGachaBiankaPassport:OnAwake()
...
function XUiGachaBiankaPassport:OnStart(reward, callBack)
    ...
    self.BtnWear:SetNameByGroup(0, XUiHelper.GetText(self._IsBackGround and "GachaBiankaBgBtn" or "GachaBiankaFashionBtn"))
...
function XUiGachaBiankaPassport:Close()
...
function XUiGachaBiankaPassport:OnWear()
...
function XUiGachaBiankaPassport:OnSetAssistant()
    self.BtnSetAssistant.gameObject:SetActiveEx(false)

---@class XUiPanelGachaBiankaRecord : XUiNode
---@field Parent XUiGachaBiankaLog
local XUiPanelGachaBiankaRecord = XClass(XUiNode, "XUiPanelGachaBiankaRecord")

function XUiPanelGachaBiankaRecord:OnStart()
    self._TypeText = {}
    self:SetTypeText()
end

function XUiPanelGachaBiankaRecord:SetTypeText()
...
function XUiPanelGachaBiankaRecord:RefreshUiShow(gachaConfig)
...
function XUiPanelGachaBiankaRecord:SetLogData(name, templateId, from, time, quality)
...
return XUiPanelGachaBiankaRecord
---@class XUiGridGachaBiankaStageItem : XUiNode
---@field Parent XUiGachaBiankaStageLine
local XUiGridGachaBiankaStageItem = XClass(XUiNode, "XUiGridGachaBiankaStageItem")

function XUiGridGachaBiankaStageItem:SetNormalStage()
...
function XUiGridGachaBiankaStageItem:SetPassStage()
    self.PanelStagePass.gameObject:SetActiveEx(self._FStage:GetIsPass())
end

function XUiGridGachaBiankaStageItem:UpdateNode(index, festivalId, stageId)
...
function XUiGridGachaBiankaStageItem:OnBtnStageClick()
...
function XUiGridGachaBiankaStageItem:SetNodeSelect(isSelect)
    if not self._IsLock and self.ImageSelected then
        self.ImageSelected.gameObject:SetActiveEx(isSelect)
    end
end

function XUiGridGachaBiankaStageItem:ResetItemPosition(pos)
    if self.ImgHideLine then
...
return XUiGridGachaBiankaStageItem
...
---@class XUiGachaBiankaStageDetail : XLuaUi
local XUiGachaBiankaStageDetail = XLuaUiManager.Register(XLuaUi, "UiGachaBianka402StageDetail")

function XUiGachaBiankaStageDetail:OnAwake()
    ---@type XUiGridCommon[]
    self._GridList = {}
...
function XUiGachaBiankaStageDetail:OnStart(stageId)
...
function XUiGachaBiankaStageDetail:OnEnable()
...
function XUiGachaBiankaStageDetail:PlayStoryId(movieId)
    XDataCenter.MovieManager.PlayMovie(movieId)
end

function XUiGachaBiankaStageDetail:OnBtnEnterClick()
    local stageCfg = self._StageCfg
...
return XUiGachaBiankaStageDetail
...
function XUiFubenMainLineChapter:AutoInitUi()
    ...
    self.BtnTreasureBg = self.Transform:Find("SafeAreaContentPane/PanelTreasure/BtnTreasureBg"):GetComponent(typeof(CS.UnityEngine.UI.Button))
    self.PanelReward = self.Transform:Find("SafeAreaContentPane/PanelTreasure/PanelReward")
    self.TxtTreasureTitle = self.Transform:Find("SafeAreaContentPane/PanelTreasure/PanelReward/TxtTreasureTitle"):GetComponent(typeof(CS.UnityEngine.UI.Text))
    ...
    self.TxtChapter = self.Transform:Find("SafeAreaContentPane/PanelMainlineChapter/PanelChapterName/TxtChapter"):GetComponent(typeof(CS.UnityEngine.UI.Text))
    self.TxtChapterName = self.Transform:Find("SafeAreaContentPane/PanelMainlineChapter/PanelChapterName/TxtChapterName"):GetComponent(typeof(CS.UnityEngine.UI.Text))
    self.Text_1 = self.Transform:Find("SafeAreaContentPane/PanelMainlineChapter/PanelInfo/PanelActivityTime/Text_1"):GetComponent(typeof(CS.UnityEngine.UI.Text))
    self.PanelTopDifficult = self.Transform:Find("SafeAreaContentPane/PanelMainlineChapter/PanelTopDifficult")
    self.BtnNormal = self.Transform:Find("SafeAreaContentPane/PanelMainlineChapter/PanelTopDifficult/BtnNormal"):GetComponent(typeof(CS.UnityEngine.UI.Button))
    ...
    self.BtnHard = self.Transform:Find("SafeAreaContentPane/PanelMainlineChapter/PanelTopDifficult/BtnHard"):GetComponent(typeof(CS.UnityEngine.UI.Button))
    ...
    self.BtnVt = self.Transform:Find("SafeAreaContentPane/PanelMainlineChapter/PanelTopDifficult/BtnVt"):GetComponent(typeof(CS.UnityEngine.UI.Button))
    ...
    self.BtnSkip = self.Transform:Find("SafeAreaContentPane/PanelMainlineChapter/PanelMoney/PanelMoenyGroup/PanelBountyTask/PanelStart/BtnSkip"):GetComponent(typeof(CS.UnityEngine.UI.Button))
    self.TxtLevel = self.Transform:Find("SafeAreaContentPane/PanelMainlineChapter/PanelMoney/PanelMoenyGroup/PanelBountyTask/PanelStart/TxtLevel"):GetComponent(typeof(CS.UnityEngine.UI.Text))
    ...
    self.BtnBountyTask = self.Transform:Find("SafeAreaContentPane/PanelMainlineChapter/PanelMoney/PanelMoenyGroup/PanelBountyTask/PanelComplete/BtnBountyTask"):GetComponent(typeof(CS.UnityEngine.UI.Button))
    self.PanelChapter = self.Transform:Find("SafeAreaContentPane/PanelMainlineChapter/PanelChapter")
    self.BtnCloseDifficult = self.Transform:Find("SafeAreaContentPane/PanelMainlineChapter/BtnCloseDifficult"):GetComponent(typeof(CS.UnityEngine.UI.Button))
    self.BtnCloseDetail = self.Transform:Find("SafeAreaContentPane/PanelMainlineChapter/BtnCloseDetail"):GetComponent(typeof(CS.UnityEngine.UI.Button))
end
...
function XUiFubenMainLineChapter:UpdateCurChapter(chapter)
    ...
    -- 据点关卡消失打印字段
    data.IsBfrt = self:CheckIsBfrtType()
    ...
    if self.CurChapterGridName ~= prefabName then
        ...
        if self.IsExploreMod then
            ...
            if self.bg1Trans then
                self.RImgBg1 = self.bg1Trans:GetComponent(typeof(CS.UnityEngine.CanvasGroup))
...
function XUiFubenMainLineChapter:OnBtnVtClick(IsAutoMove)
    if self.IsShowDifficultPanel then
        local chapterInfo = XDataCenter.FubenMainLineManager.GetChapterInfoForOrderId(XDataCenter.FubenManager
                .DifficultVariations, self
    .Chapter.OrderId)

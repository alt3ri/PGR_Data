...
function XUiFubenBranchStageDetail:OnBtnCloseClick()
    self:CloseWithAnimDisable()
end
-- auto
function XUiFubenBranchStageDetail:OnBtnAddNumClick()
...
function XUiFubenBranchStageDetail:OnBtnEnterClick()
    local stage = self.Stage

...
function XUiPanelStrongholdRoomCharacterSelfV2P6:RefreshRoleDetail()
    ...
    local initColor = self.CharacterAgency:GetModelCharacterQualityIconInitColor(initQuality)
    ...
    -- 机制
    local generalSkillIds = XMVCA.XCharacter:GetCharactersActiveGeneralSkillIdList(self.Parent.CharacterId)

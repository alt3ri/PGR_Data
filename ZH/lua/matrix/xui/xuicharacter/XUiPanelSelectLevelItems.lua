...
function XUiPanelSelectLevelItems:AutoInitUi()
    ...
    self.BtnUpgrade = self.Transform:Find("PanelItems/PanelLvInfo/BtnUpgrade"):GetComponent(typeof(CS.UnityEngine.UI.Button))
    self.ImgMaxLevel = self.Transform:Find("PanelItems/PanelLvInfo/ImgMaxLevel"):GetComponent(typeof(CS.UnityEngine.UI.Image))
    self.PanelLevel = self.Transform:Find("PanelItems/PanelLevel")
    self.TxtExpCompare = self.Transform:Find("PanelItems/PanelLevel/LevelBarInfo/TxtExpCompare"):GetComponent(typeof(CS.UnityEngine.UI.Text))
    self.TxtAddExp = self.Transform:Find("PanelItems/PanelLevel/LevelBarInfo/TxtAddExp"):GetComponent(typeof(CS.UnityEngine.UI.Text))
    self.TxtShowLevel = self.Transform:Find("PanelItems/PanelLevel/LevelBarInfo/TxtShowLevel"):GetComponent(typeof(CS.UnityEngine.UI.Text))
    self.TxtCharCurLevel = self.Transform:Find("PanelItems/PanelLevel/LevelBarInfo/TxtCharCurLevel"):GetComponent(typeof(CS.UnityEngine.UI.Text))
    self.ImgExpBar = self.Transform:Find("PanelItems/PanelLevel/LevelBarInfo/ImgExpBar"):GetComponent(typeof(CS.UnityEngine.UI.Image))
    self.ImgExpAddBar = self.Transform:Find("PanelItems/PanelLevel/LevelBarInfo/ImgExpAddBar"):GetComponent(typeof(CS.UnityEngine.UI.Image))

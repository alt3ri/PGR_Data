...
function XUiSkillDetailsTips:OnStart(data, skillLv, forceHideGotoEnhanceSkillBtn)
    if not data then
        return
    end
    self.Data = data
    ...
    local isShowBtnGotoEnhanceSkill = character and isEnhanceSkill and isEnhanceSkillLock and not forceHideGotoEnhanceSkillBtn
...
function XUiSkillDetailsTips:OnBtnGotoEnhanceSkillClick()

...
---@class XUiGridGachaAlphaResult : XUiNode
---@field Parent XUiGachaAlphaShow
local XUiGridGachaAlphaResult = XClass(XUiNode, "XUiGridGachaAlphaResult")

function XUiGridGachaAlphaResult:OnStart()
    self:InitUiObject()
end

function XUiGridGachaAlphaResult:InitUiObject()
...
function XUiGridGachaAlphaResult:SetData(rewardInfo)
...
function XUiGridGachaAlphaResult:LoadEffect(id)
...
function XUiGridGachaAlphaResult:SetBgRawImage(id)
...
return XUiGridGachaAlphaResult
---@class XUiGridGachaAlphaStageItem : XUiNode
---@field Parent XUiGachaAlphaStageLine
local XUiGridGachaAlphaStageItem = XClass(XUiNode, "XUiGridGachaAlphaStageItem")

function XUiGridGachaAlphaStageItem:SetNormalStage()
...
function XUiGridGachaAlphaStageItem:SetPassStage()
    self.PanelStagePass.gameObject:SetActiveEx(self._FStage:GetIsPass())
end

function XUiGridGachaAlphaStageItem:UpdateNode(index, festivalId, stageId)
...
function XUiGridGachaAlphaStageItem:OnBtnStageClick()
...
function XUiGridGachaAlphaStageItem:SetNodeSelect(isSelect)
    if not self._IsLock and self.ImageSelected then
        self.ImageSelected.gameObject:SetActiveEx(isSelect)
    end
end

function XUiGridGachaAlphaStageItem:ResetItemPosition(pos)
    if self.ImgHideLine then
...
return XUiGridGachaAlphaStageItem
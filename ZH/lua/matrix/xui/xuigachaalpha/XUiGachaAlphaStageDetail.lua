...
---@class XUiGachaAlphaStageDetail : XLuaUi
local XUiGachaAlphaStageDetail = XLuaUiManager.Register(XLuaUi, "UiGachaAlphaStageDetail")

function XUiGachaAlphaStageDetail:OnAwake()
    ---@type XUiGridCommon[]
    self._GridList = {}
...
function XUiGachaAlphaStageDetail:OnStart(stageId)
...
function XUiGachaAlphaStageDetail:OnEnable()
...
function XUiGachaAlphaStageDetail:PlayStoryId(movieId)
    XDataCenter.MovieManager.PlayMovie(movieId)
end

function XUiGachaAlphaStageDetail:OnBtnEnterClick()
    local stageCfg = self._StageCfg
...
return XUiGachaAlphaStageDetail
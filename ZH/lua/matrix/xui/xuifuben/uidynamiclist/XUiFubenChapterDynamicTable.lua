...
---@class XUiFubenChapterDynamicTable
...
function XUiFubenChapterDynamicTable:GetCurrentSelectedGrid()
    if not XTool.IsTableEmpty(self.GridDic) and XTool.IsNumberValid(self.CurrentSelectedIndex) then
        return self.GridDic[self.CurrentSelectedIndex]
    end
end

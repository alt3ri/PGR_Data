...
function XUiSkyGardenShoppingStreetBuildBtnList:IsShowBtnUpgrade()
...
function XUiSkyGardenShoppingStreetBuildBtnList:Update(data)
    ...
    XTool.UpdateDynamicItemByUiCache(self._BuildingBtn, data.ShopConfigs, self.GridBuild.transform.parent, XUiSkyGardenShoppingStreetBuildBtn, self)
end

---@class XGuideRecordNode : XLuaBehaviorNode 通知服务器记录行为树已经完成
...
function XGuideRecordNode:OnEnter()
    ...
    local guideGroup = XDataCenter.GuideManager.GetGuideGroupTemplatesById(self.GuideId)
    local config = XDataCenter.GuideManager.GetGuideCompleteTemplatesById(guideGroup.CompleteId)

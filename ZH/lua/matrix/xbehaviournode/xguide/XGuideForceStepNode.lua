---@class GuideForceStepNode : XLuaBehaviorNode 引导强制执行
---@field Type number 执行类型
---@field Par1 string 自定义参数1
---@field Par2 string 自定义参数2
...
function GuideForceStepNode:OnEnter()
    ...
    elseif type == GuideForceStepType.OpenAwarenessDetail then
        ...
        if ui then
            ...
            ui.UiProxy.UiLuaTable.SelectEquipId = XMVCA.XEquip:GetFirstEquip(templateId).Id

...
local type = {
    ...
    CONDITION_PLAYER_GENDERSET = "XRedPointConditionPlayerGenderSet", -- 未设置性别
    ...
    CONDITION_ARCHIVE_COMIC_GROUP_RED = "XArchive/XRedPointArchiveComicGroupRed", -- 漫画组蓝点
    CONDITION_ARCHIVE_COMIC_RED = "XArchive/XRedPointArchiveComicRed", -- 漫画章节蓝点
    --回归活动红点相关
    ...
    --库洛姆人物活动红点
    CONDITION_DMCCHARACTIVITYMAINRED = "XRedPointConditionDMCCharActivity", -- 3.5鬼泣联动角色试玩总蓝点，包含两个角色的子红点
    ...
    CONDITION_GUILDWAR_MENU = "XRedPointConditionGuildWarMenu", -- 公会战界面菜单入口
    --动作塔防
    ...
    CONDITION_ACTIVITY_FESTIVAL_DMC = "XRedPointActivityFestivalDMC", -- 3.5鬼泣联动剧情关
    --音游
    ...
    -- 战双工艺
    CONDITION_LINKCRAFT_MAIN = "XLinkCraftActivity/XRedPointLinkCraftActivityMain",
    CONDITION_LINKCRAFT_NEWCHAPTER = "XLinkCraftActivity/XRedPointLinkCraftActivityNewChapter",
    CONDITION_LINKCRAFT_EXCHANGEABLE = "XLinkCraftActivity/XRedPointLinkCraftActivityExchangeable",
    -- 庙会
    ...
    -- Boss跃升
    CONDITION_BOSS_INSHOT = "XRedPointConditionBossInshot",
    -- 机制玩法
    CONDITION_MECHANISM_MAIN = "XMechanismActivity/XRedPointMechanismActivityMain",
    ...
    -- 背包整理玩法
    CONDITION_BAGORGANIZE_ANY = "XBagOrganizeActivity/XRedPointBagOrganizeActivityAny", -- 玩法总蓝点
    CONDITION_BAGORGANIZE_NEWCHAPTER = "XBagOrganizeActivity/XRedPointBagOrganizeActivityNewChapter",
    CONDITION_BAGORGANIZE_TASK = "XBagOrganizeActivity/XRedPointBagOrganizeActivityTask",
    
    CONDITION_THEATRE4_ACTIVITY = "XRedPointConditionTheatre4Activity",
    -- 庙会2
    CONDITION_TEMPLE2 = "XRedPointConditionTemple2",
    -- 2048玩法
    ...
    CONDITION_SUCCEED_BOSS_CHAPTER = "XRedPointConditionSucceedBossChapter",
    
    -- 数织小游戏
    CONDITION_NONOGRAM_MAIN = "XRedPointConditionNonogramMain",
    CONDITION_NONOGRAM_CHAPTER = "XRedPointConditionNonogramChapter",
    -- Fps
    CONDITION_FPSGAME_MAIN = "XRedPointConditionFpsGameMain", -- 活动入口
    -- 孤胆枪手
    CONDITION_MAVERICK3_MAIN = "XRedPointConditionMaverick3Main", -- 活动入口
    
    -- 轮椅手册
    CONDITION_WHEELCHAIRMANUAL_MAIN = "XWheelChairManual/XRedPointXWheelChairManualMain", -- 总蓝点
    CONDITION_WHEELCHAIRMANUAL_PLANREWARD = "XWheelChairManual/XRedPointXWheelChairManualPlanReward", -- 阶段奖励
    CONDITION_WHEELCHAIRMANUAL_PLANTASK = "XWheelChairManual/XRedPointXWheelChairManualPlanTask", -- 阶段任务
    CONDITION_WHEELCHAIRMANUAL_BP = "XWheelChairManual/XRedPointXWheelChairManualBP", -- BP奖励
    CONDITION_WHEELCHAIRMANUAL_LOTTO = "XWheelChairManual/XRedPointXWheelChairManualLotto", -- 卡池
    CONDITION_WHEELCHAIRMANUAL_GIFT = "XWheelChairManual/XRedPointXWheelChairManualGift", -- 礼包
    CONDITION_WHEELCHAIRMANUAL_TEACHING = "XWheelChairManual/XRedPointXWheelChairManualTeaching", -- 教学关
    CONDITION_WHEELCHAIRMANUAL_GUIDE = "XWheelChairManual/XRedPointXWheelChairManualGuide", -- 活动引导
    CONDITION_WHEELCHAIRMANUAL_ENTRANCE_CHANGE = "XWheelChairManual/XRedPointXWheelChairManualEntranceChange", -- 入口转移
    -- 策划精选关
    CONDITION_STAGE_MEMORY = "XRedPointConditionStageMemory",

    -- 拉人活动
    CONDITION_RECALL_ENTRANCE = "XRedPointConditionReCallEntrance",
    CONDITION_RECALL_REWARD = "XRedPointConditionReCallReward",
    CONDITION_RECALL_INVITE = "XRedPointConditionReCallInvite",
    
    -- 3.1可肝卡池
    CONDITION_GACHACANLIVER_MAIN = "XGachaCanLiver/XRedPointGachaCanLiverMain", -- 总蓝点
    CONDITION_GACHACANLIVER_SHOP = "XGachaCanLiver/XRedPointGachaCanLiverShop", -- 商店
    CONDITION_GACHACANLIVER_TASK = "XGachaCanLiver/XRedPointGachaCanLiverTask", -- 任务
    CONDITION_GACHACANLIVER_TIMELIMITDRAW = "XGachaCanLiver/XRedPointGachaCanLiverTimelimitDraw", -- 限时卡池
    CONDITION_GACHACANLIVER_DRAW = "XGachaCanLiver/XRedPointGachaCanLiverDraw", -- 常驻卡池
    
    -- 合版本活动
    CONDITION_VERSIONGIFT_TASK = "XVersionGift/XRedPointVersionGiftTask", -- 任务
    ...
    -- 打牌
    CONDITION_PCG_ACTIVITY = "XRedPointConditionPcgActivity", -- 活动入口
    
    -- 情人节活动2024
    CONDITION_POKER_GUESSING2 = "XRedPointConditionPokerGuessing2Red",
    -- 自选500Gacha皮肤卡池
    CONDITION_GACHA_FASHION_SELF_CHOICE = "XRedPointConditionGachaFashionSelfChoice",
    CONDITION_LOTTO_FASHION_SELF_CHOICE = "XRedPointConditionLottoFashionSelfChoice",
    
    --- 新矿区
    CONDITION_SCORETOWER_MAIN = "XScoreTower/XRedPointScoreTowerMain", -- 活动总蓝点
    CONDITION_SCORETOWER_NEWCHAPTER = "XScoreTower/XRedPointScoreTowerNewChapter", -- 新章节蓝点
    CONDITION_SCORETOWER_RANK = "XScoreTower/XRedPointScoreTowerRank", -- 排行榜蓝点
    CONDITION_SCORETOWER_TASK = "XScoreTower/XRedPointScoreTowerTask", -- 任务蓝点
    
    -- 吃豆人
    CONDITION_PACMAN2_NEW_STAGE = "XPacMan2/XRedPointPacMan2",
    
    -- 悬赏挑战
    CONDITION_BOUNTY_CHALLENGE = "XBountyChallenge/XRedPoint2BountyChallenge",

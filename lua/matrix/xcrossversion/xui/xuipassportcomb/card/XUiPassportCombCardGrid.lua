...
---@class XUiPassportCombCardGrid:XUiNode
local XUiPassportCombCardGrid = XClass(XUiNode, "XUiPassportCombCardGrid")


local CSXTextManagerGetText = CS.XTextManager.GetText

function XUiPassportCombCardGrid:Ctor(ui)
    self.RewardPanelList = {}
end

function XUiPassportCombCardGrid:Init(rootUi)
    self.RootUi = rootUi
end

function XUiPassportCombCardGrid:Refresh(passportBuyRewardShowId)
...
return XUiPassportCombCardGrid
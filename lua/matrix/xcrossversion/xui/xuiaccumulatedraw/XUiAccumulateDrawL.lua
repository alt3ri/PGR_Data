...
---@class UiCombAccumulateDraw : XLuaUi
...
---@field _Control XAccumulateExpendControlL
local XUiAccumulateDraw = XLuaUiManager.Register(XLuaUi, "UiCombAccumulateDraw")
...
function XUiAccumulateDraw:OnAwake()
    ...
    self:_InitUi()
    --self:_InitSpecialTool() --日服屏蔽虹卡显示
...
function XUiAccumulateDraw:OnBtnHelpClick()
    XLuaUiManager.Open("UiCombAccumulateDrawLog")
end
...
--海外修改，新增条款显示
function XUiAccumulateDraw:OnBtnLaw1()
    local lawTxt
    local lawTitle
...
function XUiAccumulateDraw:OnBtnLaw2()
    local lawTxt
    local lawTitle
...
function XUiAccumulateDraw:_RefreshDynamicTable(isRefresh)
    ...
    self._DynamicTable:ReloadDataASync(index)
end

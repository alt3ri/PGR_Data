local XUiFunbenWeiLaTutorial = XLuaUiManager.Register(XLuaUi, "UiFunbenWeiLaTutorialV211")
...
function XUiFunbenWeiLaTutorial:CheckRedPoint()
    XRedPointManager.Check(self.RedPointBtnAchievementId,self.Id)
    XRedPointManager.Check(self.RedPointBtnTeachingId,self.Id)
    XRedPointManager.Check(self.RedPointBtnChallengeId,self.Id)
...
function XUiFunbenWeiLaTutorial:InitStarts()
    ...
    if not totalStars or not curStars then
        return
    end

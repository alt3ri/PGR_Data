...
---@field Parent XUiRiftAttributeSlider
...
function XUiPanelRiftSysAttribute:OnStart(attrId)
    ...
    local attrs = self._Control:GetSystemAttr(attrId)
    ...
    self.TxtTitle1.text = self._Control:GetTeamAttributeConfig(attrId).Name
    ...
    for i, v in ipairs(datas) do
        ...
        if attrs.Config.ShowType == XEnumConst.Rift.AttributeFixEffectType.Percent then

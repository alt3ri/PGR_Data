...
function XActivityBrieIsOpen.FubenActivityTrial()
    ...
    --local chapters = XMVCA.XFashionStory:GetActivityChapters(true)
    --local beginTime = math.huge
    --local endTime = 0
    --for _,chapter in pairs(chapters) do
    --    local chapterStartTime, chapterEndTime = XMVCA.XFashionStory:GetActivityTime(chapter.Id)

local XUiGridStrongholdPlugin = XClass(nil, "XUiGridStrongholdPlugin")

function XUiGridStrongholdPlugin:Ctor(ui, clickCb)
...
function XUiGridStrongholdPlugin:Refresh(plugin, isAllPluginEmpty, doNotShowEffect)
    self.Plugin = plugin
...
return XUiGridStrongholdPlugin
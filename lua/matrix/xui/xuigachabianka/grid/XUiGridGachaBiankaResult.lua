...
---@class XUiGridGachaBiankaResult : XUiNode
---@field Parent XUiGachaBiankaShow
local XUiGridGachaBiankaResult = XClass(XUiNode, "XUiGridGachaBiankaResult")

function XUiGridGachaBiankaResult:OnStart()
    self:InitUiObject()
end

function XUiGridGachaBiankaResult:InitUiObject()
    ...
    self.GridChip:SetCustomItemTip(function(data, hideSkipBtn, rootUiName, lackNum)
...
function XUiGridGachaBiankaResult:SetData(rewardInfo)
    ...
    self.Parent:SetDrawEffectGroupId(effectGroupId)
...
function XUiGridGachaBiankaResult:LoadEffect(id)
...
function XUiGridGachaBiankaResult:SetBgRawImage(id)
...
return XUiGridGachaBiankaResult
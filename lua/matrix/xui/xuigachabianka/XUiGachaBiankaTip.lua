---@class XUiGachaBiankaTip : XLuaUi
local XUiGachaBiankaTip = XLuaUiManager.Register(XLuaUi, "UiGachaBianka402Tip")

local type = type

function XUiGachaBiankaTip:OnAwake()
    self:InitAutoScript()
end

function XUiGachaBiankaTip:OnStart(data, hideSkipBtn, rootUiName, lackNum, showNum, switchRainbowCard, title, isShowCount)
...
function XUiGachaBiankaTip:OnEnable()
    self:Refresh(self.Data)
end

function XUiGachaBiankaTip:OnDisable()

end

function XUiGachaBiankaTip:OnDestroy()

end

function XUiGachaBiankaTip:ShowCurrentRainbowCard()
...
function XUiGachaBiankaTip:InitAutoScript()
    self.SpecialSoundMap = {}
    self:AutoAddListener()
end

function XUiGachaBiankaTip:GetAutoKey(uiNode, eventName)
    if not uiNode then
        return
    end
...
function XUiGachaBiankaTip:RegisterListener(uiNode, eventName, func)
...
function XUiGachaBiankaTip:AutoAddListener()
...
-- auto
function XUiGachaBiankaTip:OnBtnBackClick()
    self:Close()
end

function XUiGachaBiankaTip:OnBtnGetClick()
    XLuaUiManager.Open("UiSkip", self.TemplateId, function()
        self:Close()
    end, self.HideSkipBtn)
end

function XUiGachaBiankaTip:OnBtnOkClick()
    self:Close()
end

function XUiGachaBiankaTip:OnBtnTcanchaungBlackClick()
...
function XUiGachaBiankaTip:OnBtnActionClick()
...
function XUiGachaBiankaTip:SetUiActive(ui, active)
...
function XUiGachaBiankaTip:ResetUi()
...
function XUiGachaBiankaTip:Refresh(data)
    self.Data = data
    if not data then
...
--===============
function XUiGachaBiankaTip:SetTempData(data)
    -- 名称
...
function XUiGachaBiankaTip:OnGetEvents()
    return {
        XEventId.EVENT_ITEM_FAST_TRADING
    }
end

function XUiGachaBiankaTip:OnNotify(evt, ...)

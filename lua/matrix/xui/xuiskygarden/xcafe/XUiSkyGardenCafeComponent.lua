...
function XUiSkyGardenCafeComponent:OnStart()
    ...
    agency:AddInnerEvent(EventId.EVENT_CAFE_HUD_REFRESH, self.RefreshHud, self)
    agency:AddInnerEvent(EventId.EVENT_CAFE_HUD_HIDE, self.HideHud, self)
end
...
function XUiSkyGardenCafeComponent:OnDestroy()
    ...
    local agency = XMVCA.XSkyGardenCafe
    agency:RemoveInnerEvent(EventId.EVENT_CAFE_HUD_REFRESH, self.RefreshHud, self)
    agency:RemoveInnerEvent(EventId.EVENT_CAFE_HUD_HIDE, self.HideHud, self)
end

---@class XUiEpicFashionGachaPassport : XLuaUi
local XUiEpicFashionGachaPassport = XLuaUiManager.Register(XLuaUi, "UiEpicFashionGachaPassport")

function XUiEpicFashionGachaPassport:OnAwake()
...
function XUiEpicFashionGachaPassport:OnStart(reward, callBack)
...
function XUiEpicFashionGachaPassport:Close()
...
function XUiEpicFashionGachaPassport:OnWear()
...
function XUiEpicFashionGachaPassport:OnSetAssistant()
    self.BtnSetAssistant.gameObject:SetActiveEx(false)
...
return XUiEpicFashionGachaPassport
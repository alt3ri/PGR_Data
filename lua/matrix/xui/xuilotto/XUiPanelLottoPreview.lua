...
function XUiPanelLottoPreview:Ctor(ui, base, data, weaponFashionId, weaponFashionDesc)
    ...
    self.WeaponFashionDesc = weaponFashionDesc
    self.RewardCore = {}
    self.RewardFirst = {}
    self.RewardSecond = {}
    self.RewardThird = {}
    ...
    for _, rewardData in pairs(rewardDataList) do
        if rewardData:GetRareLevel() == rareLevel and uiObjDir["Grid"..gridCount] then
            ...
            if not reward then
                ...
                if self.WeaponFashionId and self.WeaponFashionDesc then
                    reward.Grid:SetCustomWeaopnFashionId(self.WeaponFashionId, self.WeaponFashionDesc)
                end

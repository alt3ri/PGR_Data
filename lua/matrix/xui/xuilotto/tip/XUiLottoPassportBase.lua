...
function XUiLottoPassportBase:OnStart(reward, callBack)
    ...
    self.BtnWear:SetNameByGroup(0, XUiHelper.GetText(self._IsBackGround and "LottoKareninaBgBtn" or "LottoKareninaFashionBtn"))
...
function XUiLottoPassportBase:OnBtnCloseClick()
    self:Close(self)
...
function XUiLottoPassportBase:OnWear()
...
function XUiLottoPassportBase:OnSetAssistant()
    self.BtnSetAssistant.gameObject:SetActiveEx(false)

...
function XUiPacMan2Game:OnAwake()
    ...
    -- 用RegisterClickEvent注册的按钮, 不支持按下触发功能
    --XUiHelper.RegisterClickEvent(self, self.BtnUp, self.OnClickUp)
    ...
    self.BtnUp.CallBack = function()
        self:OnClickUp()
    end
    self.BtnDown.CallBack = function()
        self:OnClickDown()
    end

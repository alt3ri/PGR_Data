...
function XUiPanelDormTaskDaily:UpdateActiveness()
    ...
    for i = 1, #self.PanelActiveGrids do
        ...
        local x = self.ActiveProgressPosition.x + i * itemOffset - offsetWidth - itemWidth
        local adjustPosition = CS.UnityEngine.Vector3(x, self.OriginPosition.y, self.OriginPosition.z)

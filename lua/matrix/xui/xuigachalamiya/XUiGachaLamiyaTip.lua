...
---@class XUiGachaLamiyaTip : XLuaUi
local XUiGachaLamiyaTip = XLuaUiManager.Register(XLuaUi, "UiGachaLamiyaTip")

local type = type

function XUiGachaLamiyaTip:OnAwake()
    self:InitAutoScript()
end

function XUiGachaLamiyaTip:OnStart(data, hideSkipBtn, rootUiName, lackNum, showNum, switchRainbowCard, title, isShowCount)
...
function XUiGachaLamiyaTip:OnEnable()
    self:Refresh(self.Data)
end

function XUiGachaLamiyaTip:OnDisable()

end

function XUiGachaLamiyaTip:OnDestroy()

end

function XUiGachaLamiyaTip:ShowCurrentRainbowCard()
...
function XUiGachaLamiyaTip:InitAutoScript()
    self.SpecialSoundMap = {}
    self:AutoAddListener()
end

function XUiGachaLamiyaTip:GetAutoKey(uiNode, eventName)
    if not uiNode then
        return
    end
...
function XUiGachaLamiyaTip:RegisterListener(uiNode, eventName, func)
...
function XUiGachaLamiyaTip:AutoAddListener()
...
-- auto
function XUiGachaLamiyaTip:OnBtnBackClick()
    self:Close()
end

function XUiGachaLamiyaTip:OnBtnGetClick()
    XLuaUiManager.Open("UiSkip", self.TemplateId, function()
        self:Close()
    end, self.HideSkipBtn)
end

function XUiGachaLamiyaTip:OnBtnOkClick()
    self:Close()
end

function XUiGachaLamiyaTip:OnBtnTcanchaungBlackClick()
...
function XUiGachaLamiyaTip:OnBtnActionClick()
...
function XUiGachaLamiyaTip:SetUiActive(ui, active)
...
function XUiGachaLamiyaTip:ResetUi()
...
function XUiGachaLamiyaTip:Refresh(data)
    self.Data = data
    if not data then
...
--===============
function XUiGachaLamiyaTip:SetTempData(data)
    -- 名称
...
function XUiGachaLamiyaTip:OnGetEvents()
    return {
        XEventId.EVENT_ITEM_FAST_TRADING
    }
end

function XUiGachaLamiyaTip:OnNotify(evt, ...)

...
---@class XUiGridGachaShowReward : XUiNode
---@field Parent XUiGachaLamiyaShow
local XUiGridGachaShowReward = XClass(XUiNode, "XUiGridGachaShowReward")
...
function XUiGridGachaShowReward:OnStart(uiPanel, farCamera, nearCamera, uiCamera)

...
local TabIndex2AreaType = { XMVCA.XRestaurant.AreaType.FoodArea, XMVCA.XRestaurant.AreaType.IngredientArea }
...
function XUiRestaurantExamine:InitUi()
    ...
    self.DynamicTable:SetProxy(XUiGridStatistics, self)
...
function XUiRestaurantExamine:RefreshView()
    ...
    local list = self._Control:GetUnlockProductList(areaType)
...
function XUiRestaurantExamine:RefreshTip()
    ...
    local areaType = TabIndex2AreaType[self.TabIndex]
    local txt1 = self._Control:GetStatisticsTip(areaType, 1)
    local txt2 = self._Control:GetStatisticsTip(areaType, 2)
    local txt3 = self._Control:GetStatisticsTip(areaType, 3)

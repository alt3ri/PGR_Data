...
---@overload
function XUiKotodamaActivityBattleRoomDetailProxy:GetFilterControllerConfig()
    return XMVCA.XCharacter:GetModelCharacterFilterController()['UiKotodamaRoomRoleDetail']
end

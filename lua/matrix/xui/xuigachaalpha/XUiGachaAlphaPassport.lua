---@class XUiGachaAlphaPassport : XLuaUi 使用皮肤和场景弹框
local XUiGachaAlphaPassport = XLuaUiManager.Register(XLuaUi, "UiGachaAlphaPassport")

function XUiGachaAlphaPassport:OnAwake()
...
function XUiGachaAlphaPassport:OnStart(reward, callBack)
    ...
    self.BtnWear:SetNameByGroup(0, XUiHelper.GetText(self._IsBackGround and "GachaAlphaBgBtn" or "GachaAlphaFashionBtn"))
...
function XUiGachaAlphaPassport:Close()
...
function XUiGachaAlphaPassport:OnWear()
...
function XUiGachaAlphaPassport:OnSetAssistant()
    self.BtnSetAssistant.gameObject:SetActiveEx(false)

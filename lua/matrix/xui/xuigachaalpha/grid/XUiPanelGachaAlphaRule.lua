---@class XUiPanelGachaAlphaRule : XUiNode
---@field Parent XUiGachaAlphaLog
local XUiPanelGachaAlphaRule = XClass(XUiNode, "XUiPanelGachaAlphaRule")

function XUiPanelGachaAlphaRule:RefreshUiShow(gachaConfig)

...
---@class XUiGridGachaSelenaResult : XUiNode
---@field Parent XUiGachaSelenaShow
local XUiGridGachaSelenaResult = XClass(XUiNode, "XUiGridGachaSelenaResult")

function XUiGridGachaSelenaResult:OnStart()
    self:InitUiObject()
end

function XUiGridGachaSelenaResult:InitUiObject()
...
function XUiGridGachaSelenaResult:SetData(rewardInfo)
...
function XUiGridGachaSelenaResult:LoadEffect(id)
...
function XUiGridGachaSelenaResult:SetBgRawImage(id)
...
return XUiGridGachaSelenaResult
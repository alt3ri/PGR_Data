...
function XPreloadModel:OnInit()
    ...
    self._PreloadVersionUpdate = false
    self._CompareVersionsResult = 0
...
function XPreloadModel:InitRemoteConfig(preloadEnable, preloadBaseVersion, preloadVersion, preloadSha, preloadSize)
    ...
    self._PreloadVersionUpdate = true
...
function XPreloadModel:GetCompareVersionsResult()
    if self._PreloadVersionUpdate then
        self._PreloadVersionUpdate = false
        self._CompareVersionsResult = self:CompareVersions(self._LocalDocVersion, self._PreloadVersion)
    end
    return self._CompareVersionsResult
end
...
--   如果版本号1小于版本号2，返回-1
--   如果版本号1等于版本号2，返回0
function XPreloadModel:CompareVersions(version1, version2)
    local v1 = {}
    local v2 = {}

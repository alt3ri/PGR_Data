...
function XFangKuaiScore:AddScore(blockData, waneLen)
    ...
    local fevRadio = self._MainControl:GetFevRadio()
    self._MainControl:GetCurStageData():AddPoint(score, self:GetCombo(), self._MainControl:GetCurStageData():GetCombo(), fevRadio)
end

...
function XTurntableControl:GetTurntableMilestonePercentByTurns(turns)
    return self._Model:GetTurntableMilestonePercentByTurns(turns)
end
...
function XTurntableControl:GetSkipAnimationValue()
    return self._Model:GetSkipAnimationValue()
end

function XTurntableControl:SaveSkipAnimationValue(value)
    self._Model:SaveSkipAnimationValue(value)
end

...
function XSGCafeStage:UpdateData(stageInfo)
    ...
    self._IsKickOutCafe = stageInfo.IsKickOutCafe
end
...
--已经提出去了？
function XSGCafeStage:IsKickedOut()
    return self._IsKickOutCafe
end

function XSGCafeStage:KickedOut()
    self._IsKickOutCafe = true
end

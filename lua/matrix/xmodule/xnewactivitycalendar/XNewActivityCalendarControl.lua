...
function XNewActivityCalendarControl:CheckIsShowDormQuest()
    return self:GetAgency():CheckIsShowDormQuest()
end
...
function XNewActivityCalendarControl:GetTimeLimitActivityIds()
    return self:GetAgency():GetTimeLimitActivityIds()
end
...
-- 获取周常活动信息
function XNewActivityCalendarControl:GetWeekMainIds()
    local data = {}
    local curNum = 0
    local mainIds = self._Model:GetWeekEditShowMainIds()
    local maxNum = self._Model:GetMaxShowWeekCount()
...
function XNewActivityCalendarControl:CheckIsShowWeekEntrance()
    return self:GetAgency():CheckIsShowWeekEntrance()
end

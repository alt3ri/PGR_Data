...
function XGoldenMinerSettlementInfo:Init()
    ...
    self._SlotMachineScore = 0      --老虎机得分
    self._SlotMachineCount = 0      --老虎机全相同结算次数
end
...
function XGoldenMinerSettlementInfo:SetSlotMachineScore(score)
    self._SlotMachineScore = score
end

function XGoldenMinerSettlementInfo:SetSlotMachineCount(count)
    self._SlotMachineCount = count
end
--endregion
...
function XGoldenMinerSettlementInfo:GetSlotMachineScore()
    return self._SlotMachineScore
end

function XGoldenMinerSettlementInfo:GetSlotMachineCount()
    return self._SlotMachineCount
end
...
function XGoldenMinerSettlementInfo:GetReqServerData()
    ...
    for _, grabDataInfo in pairs(self:GetGrabDataInfos()) do
        ...
        grabDataInfoTemp.Status = grabDataInfo:GetStatus()
    ...
    settlementInfoTemp.SlotMachineScore = self:GetSlotMachineScore()
    settlementInfoTemp.SlotMachineCount = self:GetSlotMachineCount()

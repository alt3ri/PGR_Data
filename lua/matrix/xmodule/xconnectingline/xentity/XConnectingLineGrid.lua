...
function XConnectingLineGrid:IsHole()
    return self:GetAvatarId() == -1
end
...
function XConnectingLineGrid:SetGridBg(gridBg)
    self._GridBg = gridBg
end

function XConnectingLineGrid:GetGridBg()
    return self._GridBg
end

function XConnectingLineGrid:SetHeadBg(headBg)
    self._HeadBg = headBg
end

function XConnectingLineGrid:GetHeadBg()
    return self._HeadBg
end

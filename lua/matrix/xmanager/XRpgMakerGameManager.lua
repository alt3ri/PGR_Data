...
XRpgMakerGameManagerCreator = function()
    ...
    local RpgMakerGameActivityDb = nil
    ---@type XRpgMakerGameEnterStageDb
    local RpgMakerGameEnterStageDb = nil
    ---@type XRpgMakerGameScene
    ...
    local InitMonsterObj = function(mapId)
        ...
        local mapMonsterDataList = XMVCA.XRpgMakerGame:GetConfig():GetMixBlockDataListByType(mapId, XMVCA.XRpgMakerGame.EnumConst.XRpgMakeBlockMetaType.Monster)
    ...
    local InitTriggerObjDic = function(mapId)
        ...
        local mapTriggerDataList = XMVCA.XRpgMakerGame:GetConfig():GetMixBlockDataListByType(mapId, XMVCA.XRpgMakerGame.EnumConst.XRpgMakeBlockMetaType.Trigger)
    ...
    local SortActions = function()
        local newActions = {}
        local removeIndexDic = {}
        for i, action in ipairs(Actions) do
            if removeIndexDic[i] then
                goto CONTINUE
            end

            tableInsert(newActions, action)
            -- Action39出现时，提取后面的Action43
            if action.ActionType == XMVCA.XRpgMakerGame.EnumConst.RpgMakerGameActionType.ActionMonsterKnocked then
                for j = i + 1, #Actions do
                    local nextAction = Actions[j]
                    if nextAction.MonsterId == action.MonsterId and nextAction.ActionType == XMVCA.XRpgMakerGame.EnumConst.RpgMakerGameActionType.ActionMonsterDieByKnocked then
                        removeIndexDic[j] = true
                        tableInsert(newActions, nextAction)
                    end
                end
            end
            -- Action5出现时，提取后面的Action42
            if action.ActionType == XMVCA.XRpgMakerGame.EnumConst.RpgMakerGameActionType.ActionMonsterRunAway then
                for j = i + 1, #Actions do
                    local nextAction = Actions[j]
                    if nextAction.MonsterId == action.MonsterId and nextAction.ActionType == XMVCA.XRpgMakerGame.EnumConst.RpgMakerGameActionType.ActionMonsterDieByFlame then
                        removeIndexDic[j] = true
                        tableInsert(newActions, nextAction)
                    end
                end
    ...
    local CheckSetPlayElectricStatusSwitchSound = function(actions)
        ...
        for _, action in ipairs(actions or {}) do
            ...
            if triggerObj and XMVCA.XRpgMakerGame:GetConfig():GetTriggerType(triggerId) == XMVCA.XRpgMakerGame.EnumConst.XRpgMakerGameTriggerType.TriggerElectricFence then
    ...
    local InitShadowObj = function(mapId)
        ...
        local mapShadowDataList = XMVCA.XRpgMakerGame:GetConfig():GetMixBlockDataListByType(mapId, XMVCA.XRpgMakerGame.EnumConst.XRpgMakeBlockMetaType.Shadow)
    ...
    local InitElectricFenceObj = function(mapId)
        ...
        local mapElectricFenceDataList = XMVCA.XRpgMakerGame:GetConfig():GetMixBlockDataListByType(mapId, XMVCA.XRpgMakerGame.EnumConst.XRpgMakeBlockMetaType.ElectricFence)
    ...
    local InitEntityObj = function(mapId)
        ...
        for index, data in ipairs(mapEntityDataList) do
            ...
            if entityType == XMVCA.XRpgMakerGame.EnumConst.XRpgMakeBlockMetaType.Water or
                    entityType == XMVCA.XRpgMakerGame.EnumConst.XRpgMakeBlockMetaType.Ice then
                WaterObjDic[index] = XRpgMakerGameWaterData.New(index)
                WaterObjDic[index]:InitDataByMapObjData(data)
                WaterObjDic[index]:SetStatus(entityType == XMVCA.XRpgMakerGame.EnumConst.XRpgMakeBlockMetaType.Water and
                        XMVCA.XRpgMakerGame.EnumConst.XRpgMakerGameWaterType.Water or
                        XMVCA.XRpgMakerGame.EnumConst.XRpgMakerGameWaterType.Ice)
            elseif entityType == XMVCA.XRpgMakerGame.EnumConst.XRpgMakeBlockMetaType.Steel then
                SteelObjDic[index] = XRpgMakerGameSteelData.New(index)
                SteelObjDic[index]:InitDataByMapObjData(data)
            elseif entityType == XMVCA.XRpgMakerGame.EnumConst.XRpgMakeBlockMetaType.Grass then
    ...
    local InitBubbleObj = function (mapId)
        ...
        local BubbleMapDataList = XMVCA.XRpgMakerGame:GetConfig():GetMixBlockDataListByType(mapId, XMVCA.XRpgMakerGame.EnumConst.XRpgMakeBlockMetaType.Bubble)
    ...
    local InitDropObj = function (mapId)
        ...
        local DropMapDataList = XMVCA.XRpgMakerGame:GetConfig():GetMixBlockDataListByType(mapId, XMVCA.XRpgMakerGame.EnumConst.XRpgMakeBlockMetaType.Drop)
    ...
    local InitMagicObj = function (mapId)
        ...
        local MagicMapDataList = XMVCA.XRpgMakerGame:GetConfig():GetMixBlockDataListByType(mapId, XMVCA.XRpgMakerGame.EnumConst.XRpgMakeBlockMetaType.Magic)
    ...
    function XRpgMakerGameManager.GetShadowObjDic()
        return ShadowObjDic
    end
    
    function XRpgMakerGameManager.GetGrassObjDic()
        return GrassObjDic
    end
    ...
    function XRpgMakerGameManager.GetGameMonsterObjDic()
    ...
    function XRpgMakerGameManager.GetMagicObjDic()
        return MagicObjDic
    end
    
    function XRpgMakerGameManager.GetTransferPointObjDic()
        return TransferPointObjDic
    end
    
    function XRpgMakerGameManager.GetSteelObjDic()
        return SteelObjDic
    end
    
    function XRpgMakerGameManager.GetBubbleObjDic()
        return BubbleObjDic
    end
    
    function XRpgMakerGameManager.GetDropObjDic()
        return DropObjDic
    end
    ...
    function XRpgMakerGameManager.GetActivityChapters()
        ...
        if XRpgMakerGameManager.CheckActivityIsOpen(true) then
            ...
            local activityId = XMVCA.XRpgMakerGame:GetConfig():GetDefaultActivityId()
            temp.Id = activityId
            temp.Name = XMVCA.XRpgMakerGame:GetConfig():GetActivityName(activityId)
            temp.BannerBg = XMVCA.XRpgMakerGame:GetConfig():GetActivityBannerBg(activityId)
    ...
    function XRpgMakerGameManager.GetActivityEndTime()
        ...
        local timeId = XMVCA.XRpgMakerGame:GetConfig():GetActivityTimeId(activityId)
        return XFunctionManager.GetEndTimeByTimeId(timeId)
    end

    function XRpgMakerGameManager.UpdateActivityData(data)
        XRpgMakerGameManager.GetActivityDb():UpdateData(data.ActivityData)
    end
    ...
    function XRpgMakerGameManager.GetCurrTaskTimeLimitId()
        local activityId = XMVCA.XRpgMakerGame:GetConfig():GetDefaultActivityId()
        return XMVCA.XRpgMakerGame:GetConfig():GetActivityTaskTimeLimitId(activityId)
    end
    ...
    function XRpgMakerGameManager.GetDefaultChapterGroupId()
        local chapterGroupId = XMVCA.XRpgMakerGame:GetConfig():GetDefaultChapterGroupId()
        ...
        for i = totalCount, 1, -1 do
            ...
            timeId = XMVCA.XRpgMakerGame:GetConfig():GetChapterGroupOpenTimeId(chapterGroupId)
            if XFunctionManager.CheckInTimeByTimeId(timeId, true) then
                return chapterGroupId
            end
        end
    ...
    function XRpgMakerGameManager.IsChapterInTime(chapterId, isTip)
        ...
        if not isInTime and isTip then
            timeId = XMVCA.XRpgMakerGame:GetConfig():GetChapterOpenTimeId(chapterId)
    ...
    function XRpgMakerGameManager.IsPassPreChapter(chapterId, isTip)
        -- 推箱子前置章节解锁
        local preChapterId = XMVCA.XRpgMakerGame:GetConfig():GetChapterPreChapterId(chapterId)
        ...
        if not isPassPreChapter and isTip then
            XUiManager.TipErrorWithKey("RpgMakerGameIsPassPreChapter", XMVCA.XRpgMakerGame:GetConfig():GetChapterName(chapterId))
        end
    ...
    ---关卡状态情况
    ---@param rpgMakerGameStageId number
    ---@return number
    function XRpgMakerGameManager.GetRpgMakerGameStageStatus(rpgMakerGameStageId)
        ...
        if stageIsPerfectClear then
            return XMVCA.XRpgMakerGame.EnumConst.RpgMakerGameStageStatus.Perfect
        end

        local stageIsClear = XRpgMakerGameManager.IsStageClear(rpgMakerGameStageId)
        if stageIsClear then
            return XMVCA.XRpgMakerGame.EnumConst.RpgMakerGameStageStatus.Clear
        end

        local preStage = XMVCA.XRpgMakerGame:GetConfig():GetStagePreStage(rpgMakerGameStageId)
        ...
        if preStageIsClear then
            return XMVCA.XRpgMakerGame.EnumConst.RpgMakerGameStageStatus.UnLock
        end

        return XMVCA.XRpgMakerGame.EnumConst.RpgMakerGameStageStatus.Lock
    end
    ...
    function XRpgMakerGameManager.GetRpgMakerActivityStageDb(stageCfgId)
        return XRpgMakerGameManager.GetActivityDb():GetStageDb(stageCfgId)
    end
    ...
    function XRpgMakerGameManager.IsStageUnLock(stageId)
        ...
        if stageStatus ~= XMVCA.XRpgMakerGame.EnumConst.RpgMakerGameStageStatus.Lock then
            return true
        end

        local preStage = XMVCA.XRpgMakerGame:GetConfig():GetStagePreStage(stageId)
        if preStage == stageId then return false, CS.XTextManager.GetText("RpgMakerGameStageInXf") end
        local preStageNumberName = XMVCA.XRpgMakerGame:GetConfig():GetStageNumberName(preStage)
        local preStageName = XMVCA.XRpgMakerGame:GetConfig():GetStageName(preStage)
    ...
    function XRpgMakerGameManager.CheckAllChapterGroupRedPoint()
        ...
        local groupIdList = XMVCA.XRpgMakerGame:GetConfig():GetChapterGroupIdList()
        local openListCount = 0
        local timeId, isOpen
        for _, groupId in ipairs(groupIdList) do
            timeId = XMVCA.XRpgMakerGame:GetConfig():GetChapterGroupOpenTimeId(groupId)
    ...
    function XRpgMakerGameManager.CheckFirstChapterGroupRedPoint()
        ...
        for _,v in ipairs(groupIdList) do
            if XMVCA.XRpgMakerGame:GetConfig():GetChapterGroupIsFirstShow(v) then
                flag = v
            end
        end
        local haveChapterIdList = XMVCA.XRpgMakerGame:GetConfig():GetChapterIdList(flag)
    ...
    function XRpgMakerGameManager.InitStageMap(mapId)
    ...
    function XRpgMakerGameManager.ResetStageMap()
        ...
        local startPointMapDataList = XMVCA.XRpgMakerGame:GetConfig():GetMixBlockDataListByType(mapId, XMVCA.XRpgMakerGame.EnumConst.XRpgMakeBlockMetaType.StartPoint)
        local endPointMapDataList = XMVCA.XRpgMakerGame:GetConfig():GetMixBlockDataListByType(mapId, XMVCA.XRpgMakerGame.EnumConst.XRpgMakeBlockMetaType.EndPoint)
        ...
        if not XTool.IsTableEmpty(startPointMapData) then
            XRpgMakerGameManager.GetPlayerObj():InitData(startPointMapData, selectRoleId)
        end
        if not XTool.IsTableEmpty(endPointMapData) then
            XRpgMakerGameManager.GetEndPointObj():InitData(endPointMapData)
        end
        ...
        ResetMagicObj()
        ResetWaterObj()
        XRpgMakerGameManager.GetCurrentScene():StageResetTorchObj()
    ...
    function XRpgMakerGameManager.ClearStageMap()
        XRpgMakerGameManager.GetPlayerObj():Dispose()
        XRpgMakerGameManager.GetEndPointObj():Dispose()
        ClearMonsterObj()
        ClearTriggerObj()
        ClearShadowObj()
    ...
    function XRpgMakerGameManager.UpdateActionData(action)
        if action.ActionType == XMVCA.XRpgMakerGame.EnumConst.RpgMakerGameActionType.ActionPlayerMove then
            XRpgMakerGameManager.SetCurrentCount(action.CurrentCount)
            XRpgMakerGameManager.GetPlayerObj():SetFaceDirection(action.Direction)
            XRpgMakerGameManager.GetPlayerObj():UpdatePosition(action.EndPosition)
            return
        end

        if action.ActionType == XMVCA.XRpgMakerGame.EnumConst.RpgMakerGameActionType.ActionKillMonster
                or action.ActionType == XMVCA.XRpgMakerGame.EnumConst.RpgMakerGameActionType.ActionMonsterDieByTrap
                or action.ActionType == XMVCA.XRpgMakerGame.EnumConst.RpgMakerGameActionType.ActionMonsterKillByElectricFence
                or action.ActionType == XMVCA.XRpgMakerGame.EnumConst.RpgMakerGameActionType.ActionHumanKill
                or action.ActionType == XMVCA.XRpgMakerGame.EnumConst.RpgMakerGameActionType.ActionMonsterDrown
                or action.ActionType == XMVCA.XRpgMakerGame.EnumConst.RpgMakerGameActionType.ActionShadowKillMonster
        then
            --[[
        ...
        if action.ActionType == XMVCA.XRpgMakerGame.EnumConst.RpgMakerGameActionType.ActionStageWin then
            local enterStageDb = XRpgMakerGameManager:GetRpgMakerGameEnterStageDb()
        ...
        if action.ActionType == XMVCA.XRpgMakerGame.EnumConst.RpgMakerGameActionType.ActionEndPointOpen then
            XRpgMakerGameManager.GetEndPointObj():EndPointOpen()
            return
        end

        if action.ActionType == XMVCA.XRpgMakerGame.EnumConst.RpgMakerGameActionType.ActionMonsterRunAway
                or action.ActionType == XMVCA.XRpgMakerGame.EnumConst.RpgMakerGameActionType.ActionMonsterPatrol then
            local monsterObj = XRpgMakerGameManager.GetMonsterObj(action.MonsterId)
            if monsterObj then
        ...
        if action.ActionType == XMVCA.XRpgMakerGame.EnumConst.RpgMakerGameActionType.ActionMonsterChangeDirection then
            --[[
            local monsterObj = XRpgMakerGameManager.GetMonsterObj(action.MonsterId)
            if monsterObj then
                monsterObj:SetFaceDirection(action.Direction)
        ...
        if action.ActionType == XMVCA.XRpgMakerGame.EnumConst.RpgMakerGameActionType.ActionMonsterKillPlayer
                or action.ActionType == XMVCA.XRpgMakerGame.EnumConst.RpgMakerGameActionType.ActionPlayerDieByTrap
                or action.ActionType == XMVCA.XRpgMakerGame.EnumConst.RpgMakerGameActionType.ActionPlayerKillByElectricFence
                or action.ActionType == XMVCA.XRpgMakerGame.EnumConst.RpgMakerGameActionType.ActionPlayerDrown then
            XRpgMakerGameManager.GetPlayerObj():Die()
            return
        end

        if action.ActionType == XMVCA.XRpgMakerGame.EnumConst.RpgMakerGameActionType.ActionTriggerStatusChange then
        ...
        if action.ActionType == XMVCA.XRpgMakerGame.EnumConst.RpgMakerGameActionType.ActionUnlockRole then
            XRpgMakerGameManager.GetActivityDb():UpdateUnlockRoleId(action.RoleId)
            return
        end

        if action.ActionType == XMVCA.XRpgMakerGame.EnumConst.RpgMakerGameActionType.ActionShadowMove then
        ...
        if action.ActionType == XMVCA.XRpgMakerGame.EnumConst.RpgMakerGameActionType.ActionShadowDieByTrap then
            local shadowObj = XRpgMakerGameManager.GetShadowObj(action.ShadowId)
            if shadowObj then
                shadowObj:Die()
            end
        ...
        if action.ActionType == XMVCA.XRpgMakerGame.EnumConst.RpgMakerGameActionType.ActionElectricStatusChange then
            SetElectricFenceStatus(action.ElectricStatus)
            return
        end

        if action.ActionType == XMVCA.XRpgMakerGame.EnumConst.RpgMakerGameActionType.ActionSentrySign then
            local monsterObj = XRpgMakerGameManager.GetMonsterObj(action.MonsterId)
            if monsterObj then
        ...
        if action.ActionType == XMVCA.XRpgMakerGame.EnumConst.RpgMakerGameActionType.ActionSteelBrokenToTrap
                or XMVCA.XRpgMakerGame.EnumConst.RpgMakerGameActionType.ActionSteelBrokenToFlat then
            ...
            if entityObj and entityObj.SetStatus then
                entityObj:SetStatus(XMVCA.XRpgMakerGame.EnumConst.XRpgMakerGameSteelBrokenType.Flat)
            end
            return
        end

        if action.ActionType == XMVCA.XRpgMakerGame.EnumConst.RpgMakerGameActionType.ActionShadowKillByElectricFence
                or action.ActionType == XMVCA.XRpgMakerGame.EnumConst.RpgMakerGameActionType.ActionMonsterKillShadow
                or action.ActionType == XMVCA.XRpgMakerGame.EnumConst.RpgMakerGameActionType.ActionShadowDrown then
            local shadowObj = XRpgMakerGameManager.GetShadowObj(action.ShadowId)
            if shadowObj then shadowObj:Die() end
            return
        end

        if action.ActionType == XMVCA.XRpgMakerGame.EnumConst.RpgMakerGameActionType.ActionBubbleMove then
        ...
        if action.ActionType == XMVCA.XRpgMakerGame.EnumConst.RpgMakerGameActionType.ActionShadowPickupDrop
                or action.ActionType == XMVCA.XRpgMakerGame.EnumConst.RpgMakerGameActionType.ActionPlayerPickupDrop then
            local entityId = action.EntityId
    ...
    function XRpgMakerGameManager.UpdateMapStatusDb(data)
        ...
        --玩家状态
        XRpgMakerGameManager.GetPlayerObj():UpdateData(data.GamePlayer)

        --终点状态
        XRpgMakerGameManager.GetEndPointObj():UpdateData(data.EndPoint)
        ...
        for _, water in ipairs(data.Water) do
            ...
            local waterObj = XRpgMakerGameManager.GetEntityObjByPosition(water.PositionX, water.PositionY, XMVCA.XRpgMakerGame.EnumConst.XRpgMakeBlockMetaType.Water)
            if waterObj and waterObj.SetStatus then
                waterObj:SetStatus(water.WaterStatus)
            end

            ---@type XRpgMakerGameWaterData
            local iceObj = XRpgMakerGameManager.GetEntityObjByPosition(water.PositionX, water.PositionY, XMVCA.XRpgMakerGame.EnumConst.XRpgMakeBlockMetaType.Ice)
        ...
        for _, grass in ipairs(data.Grass) do
            grassObj = XRpgMakerGameManager.GetEntityObjByPosition(grass.PositionX, grass.PositionY, XMVCA.XRpgMakerGame.EnumConst.XRpgMakeBlockMetaType.Grass)
        ...
        for _, steel in ipairs(data.Steel) do
            steelObj = XRpgMakerGameManager.GetEntityObjByPosition(steel.PositionX, steel.PositionY, XMVCA.XRpgMakerGame.EnumConst.XRpgMakeBlockMetaType.Steel)
        ...
        --泡泡
        local bubbleObj
        for _, d in ipairs(data.Bubble) do
            local id = d.Id
            bubbleObj = XRpgMakerGameManager.GetBubbleObj(id)
            if bubbleObj then
                bubbleObj:UpdateData(d)
        ...
        --掉落物
        local dropObj
        for _, d in ipairs(data.Drop) do
            local id = d.Id
            dropObj = XRpgMakerGameManager.GetDropObj(id)
            if dropObj then
                dropObj:UpdateData(d)
        ...
        --魔法阵
        local magicObj
        for _, d in ipairs(data.Magic) do
            local id = d.Id
            magicObj = XRpgMakerGameManager.GetMagicObj(id)
            if magicObj then
                magicObj:UpdateData(d)
            end
        end
        
        -- 火炬
        for _, torchData in pairs(data.Torch) do
            ---@type XRpgMakerGameTorch
            local torch = XRpgMakerGameManager.GetCurrentScene():GetTorchObj(torchData.PositionX, torchData.PositionY)
    ...
    function XRpgMakerGameManager.GetMonsterDeathCount()
        ...
        for _, obj in pairs(GameMonsterObjDic) do
            monsterTypeCfg = XMVCA.XRpgMakerGame:GetConfig():GetMonsterType(obj:GetId())
            if monsterTypeCfg == XMVCA.XRpgMakerGame.EnumConst.XRpgMakerGameMonsterType.Normal and obj:IsDeath() then
                normalMonsterDeathCount = normalMonsterDeathCount + 1
            elseif monsterTypeCfg == XMVCA.XRpgMakerGame.EnumConst.XRpgMakerGameMonsterType.BOSS and obj:IsDeath() then
    ...
    function XRpgMakerGameManager.AddActions(actions)
        if actions then
            for _, action in ipairs(actions or {}) do
                InsertAction(action)
            end
    ...
    function XRpgMakerGameManager.SetCurrentScene(currentScene)
        CurrentScene = currentScene
    end

    function XRpgMakerGameManager.GetActivityDb()
        if not RpgMakerGameActivityDb then
            local XRpgMakerGameActivityDb = require("XEntity/XRpgMakerGame/XRpgMakerGameActivityDb")
            RpgMakerGameActivityDb = XRpgMakerGameActivityDb.New()
        end
        return RpgMakerGameActivityDb
    end
    ...
    function XRpgMakerGameManager.GetRandomDialogBoxId()
        ...
        local idList = XMVCA.XRpgMakerGame:GetConfig():GetRandomDialogBoxIds()
        ...
        for _, id in ipairs(idList) do
            preStageId = XMVCA.XRpgMakerGame:GetConfig():GetRandomDialogBoxPreStage(id)
            isStageClear = not XTool.IsNumberValid(preStageId) and true or XRpgMakerGameManager.IsStageClear(preStageId)
            weight = XMVCA.XRpgMakerGame:GetConfig():GetRandomDialogBoxWeight(id)
    ...
    function XRpgMakerGameManager.IsStarConditionClear(starConditionId, isWin)
        ...
        local stepCount = XMVCA.XRpgMakerGame:GetConfig():GetStarConditionStepCount(starConditionId)
        local monsterCount = XMVCA.XRpgMakerGame:GetConfig():GetStarConditionMonsterCount(starConditionId)
        local monsterBossCount = XMVCA.XRpgMakerGame:GetConfig():GetStarConditionMonsterBossCount(starConditionId)
        local monsterTotalCount = monsterCount + monsterBossCount
        local pickDropType = XMVCA.XRpgMakerGame:GetConfig():GetStarConditionDropType(starConditionId)
        local pickDropCount = XMVCA.XRpgMakerGame:GetConfig():GetStarConditionDropCount(starConditionId)
    ...
    function XRpgMakerGameManager.IsCurGapSet(posX, posY, direction)
        ...
        local nextPosX = (direction == XMVCA.XRpgMakerGame.EnumConst.RpgMakerGameMoveDirection.MoveLeft and posX - 1) or (direction == XMVCA.XRpgMakerGame.EnumConst.RpgMakerGameMoveDirection.MoveRight and posX + 1) or posX
        local nextPosY = (direction == XMVCA.XRpgMakerGame.EnumConst.RpgMakerGameMoveDirection.MoveUp and posY + 1) or (direction == XMVCA.XRpgMakerGame.EnumConst.RpgMakerGameMoveDirection.MoveDown and posY - 1) or posY
        local isBlock
    ...
    function XRpgMakerGameManager.GetEntityObjByPosition(x, y, metaType)
        local mapId = XRpgMakerGameManager.GetCurrentScene():GetMapId()
    ...
    function XRpgMakerGameManager.IsGrassShelter(x, y)
        ...
        for _, entityMapData in pairs(entityMapDataList) do
            ...
            if entityMapData:GetType() == XMVCA.XRpgMakerGame.EnumConst.XRpgMakeBlockMetaType.Grass then
    ...
    function XRpgMakerGameManager.GetOnceUnLockRoleId()
        local roleIdList = XMVCA.XRpgMakerGame:GetConfig():GetRoleIds()
    ...
    function XRpgMakerGameManager.IsUnlockRole(roleId)
        ...
        return false, XMVCA.XRpgMakerGame:GetConfig():GetRoleLockTipsDesc(roleId)
    end

    function XRpgMakerGameManager.GetUnlockRoleIdList()
        return XRpgMakerGameManager.GetActivityDb():GetUnlockRoleIdList()
    end
    -----------------角色相关 end------------------
    ...
    function XRpgMakerGameManager.RequestRpgMakerGameEnter()
        ...
        XNetwork.Call("RpgMakerGameEnterRequest", {}, function(res)
            ...
            XRpgMakerGameManager.GetActivityDb():UpdateData(res.ActivityDb or res.ActivityData)   --中途改了名字，防止出错
    ...
    function XRpgMakerGameManager.RequestRpgMakerGameMapUnlockHint(stageId, type, cb)
        ...
        XNetwork.Call("RpgMakerGameMapUnlockHintRequest", req, function(res)
            ...
            local stageDb = XRpgMakerGameManager.GetRpgMakerActivityStageDb(stageId)
            if stageDb then
                if type == XMVCA.XRpgMakerGame.EnumConst.XRpgMakerGameRoleAnswerType.Hint then
                    stageDb:SetHint(1)
                else
                    stageDb:SetAnswer(1)
                end

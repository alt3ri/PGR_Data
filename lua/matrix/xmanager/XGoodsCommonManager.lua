...
local GoodsName = {
    ...
    [XArrangeConfigs.Types.BWDIYPart] = function(templateId)
        return XMVCA.XBigWorldCommanderDIY:GetPartItemName(templateId)
    end,

    [XArrangeConfigs.Types.SgDormFashion] = function(templateId)
        return XMVCA.XSkyGardenDorm:GetFashionName(templateId)
    end,
...
local GoodsQuality = {
    ...
    [XArrangeConfigs.Types.BWDIYPart] = function(templateId)
        return XMVCA.XBigWorldCommanderDIY:GetPartItemQuality(templateId)
    end,

    [XArrangeConfigs.Types.SgDormFashion] = function(templateId)
        return XMVCA.XSkyGardenDorm:GetFashionQuality(templateId)
    end,
...
local GoodsIcon = {
    ...
    [XArrangeConfigs.Types.BWDIYPart] = function(templateId)
        return XMVCA.XBigWorldCommanderDIY:GetPartItemIcon(templateId)
    end,

    [XArrangeConfigs.Types.SgDormFashion] = function(templateId)
        return XMVCA.XSkyGardenDorm:GetFashionIcon(templateId)
    end,
...
local GoodsDescription = {
    ...
    [XArrangeConfigs.Types.BWDIYPart] = function(templateId)
        return XMVCA.XBigWorldCommanderDIY:GetPartItemDescription(templateId)
    end,

    [XArrangeConfigs.Types.SgDormFashion] = function(templateId)
        return XMVCA.XSkyGardenDorm:GetFashionDescription(templateId)
    end,
...
local GoodsWorldDesc = {
    ...
    [XArrangeConfigs.Types.BWDIYPart] = function(templateId) 
        return XMVCA.XBigWorldCommanderDIY:GetPartItemWorldDescription(templateId)
    end,

    [XArrangeConfigs.Types.SgDormFurniture] = function(templateId)
        return XMVCA.XSkyGardenDorm:GetFurnitureWorldDescription(templateId)
    end,
...
local GoodsCurrentCount = {
    ...
    [XArrangeConfigs.Types.BWDIYPart] = function(templateId) 
        return XMVCA.XBigWorldCommanderDIY:GetPartItemCount(templateId)
    end,

    [XArrangeConfigs.Types.SgDormFashion] = function(templateId)
        return XMVCA.XSkyGardenDorm:GetFashionCount(templateId)
    end,
...
GoodsShowParams[XArrangeConfigs.Types.BWDIYPart] = function(templateId)
    if not XMVCA:IsRegisterAgency(ModuleId.XBigWorldCommanderDIY) then
        XLog.Error("尚未注册模块", ModuleId.XBigWorldCommanderDIY)
        return
    end
    return XMVCA.XBigWorldCommanderDIY:GetPartItemParams(templateId)
end

GoodsShowParams[XArrangeConfigs.Types.SgDormFurniture] = function(templateId)
    if not XMVCA:IsRegisterAgency(ModuleId.XSkyGardenDorm) then
        XLog.Error("尚未注册模块", ModuleId.XSkyGardenDorm)
        return
    end
    return XMVCA.XSkyGardenDorm:GetDormFurnitureGoodsParams(templateId)
end

GoodsShowParams[XArrangeConfigs.Types.SgDormFashion] = function(templateId)
    if not XMVCA:IsRegisterAgency(ModuleId.XSkyGardenDorm) then
        XLog.Error("尚未注册模块", ModuleId.XSkyGardenDorm)
        return
    end
    return XMVCA.XSkyGardenDorm:GetDormFashionGoodsParams(templateId)
end

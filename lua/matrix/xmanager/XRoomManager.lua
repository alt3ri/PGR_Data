XRoomManagerCreator = function()
    ...
    function XRoomManager.BeginSelectRequest(cb)
        if XRoomManager.StageInfo.Type == XDataCenter.FubenManager.StageType.FubenPhoto then
    ...
    function XRoomManager.CancelMatch(cb)
        if XRoomManager.MatchType == XDataCenter.FubenManager.StageType.FubenPhoto then

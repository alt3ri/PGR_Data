...
---重炮射击敌人脚本
---@class XCharHeavyArtillery7006 : XBigWorldCharBase
---@field _uuid number 当前脚本挂载的NpcId
---@field _proxy XDlcCSharpFuncs
local XCharHeavyArtillery7006 = XDlcScriptManager.RegCharScript(7006, "XCharHeavyArtillery7006", Base)

function XCharHeavyArtillery7006:CommonInit()
    Base.CommonInit(self)
    -- 自定义参数
    self._attackRange = 10 -- 进入攻击状态的范围
    self._attackSkillActionId = 700601 -- 攻击技能 id
...
function XCharHeavyArtillery7006:TryAttackPlayer(dt)
...
function XCharHeavyArtillery7006:HandleEvent(eventType, eventArgs)
end

function XCharHeavyArtillery7006:Terminate()
end

return XCharHeavyArtillery7006

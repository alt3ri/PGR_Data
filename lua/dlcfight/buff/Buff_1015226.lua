...
function XBuffScript1015226:Init()
    ...
    Base.Init(self)
    ------------配置------------
    self.magicId = 1015227
    self.magicKind = 1015227
...
function XBuffScript1015226:Update(dt)
    --每帧执行
    Base.Update(self, dt)
    ------------执行------------
    -- 获取我方的当前属性
...
function XBuffScript1015226:HandleEvent(eventType, eventArgs)
    Base.HandleEvent(self, eventType, eventArgs)
end

function XBuffScript1015226:Terminate()
    Base.Terminate(self)
end

return XBuffScript1015226

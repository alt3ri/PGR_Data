...
--效果说明：本场双方累计造成30次点燃后触发，我方角色造成伤害提升15%，伤害减免提升15%    
...
function XBuffScript1025818:OnEnterLevel(levelId)
    ...
    --取历史的次数
    self._history = self._proxy:GetTheatre6BuffActionValue(self._uuid,self._fireKey)
...
--环境效果触发显示
function XBuffScript1025818:Update(dt)
    ------------执行------------

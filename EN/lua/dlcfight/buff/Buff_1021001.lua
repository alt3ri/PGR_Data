...
function XBuffScript1021001:Init() --初始化
    ...
    self._proxy:AddTimerTask(1.75, function()--延迟1.75秒后，释放子弹
        ...
        if self._proxy:GetBuffStacks(self._uuid, 1016243) == 2 then
            self._proxy:LaunchMissileFromPosToPos(self._uuid,10210103,10210103,Position,Position,1)--伤害子弹
        elseif self._proxy:GetBuffStacks(self._uuid, 1016243) == 3 then
            self._proxy:LaunchMissileFromPosToPos(self._uuid,10210103,10210103,Position,Position,1)--伤害子弹
            self._proxy:LaunchMissileFromPosToPos(self._uuid,10210103,10210103,Position,Position,1)--伤害子弹
        elseif self._proxy:GetBuffStacks(self._uuid, 1016243) == 4 then
            self._proxy:LaunchMissileFromPosToPos(self._uuid,10210103,10210103,Position,Position,1)--伤害子弹
            self._proxy:LaunchMissileFromPosToPos(self._uuid,10210103,10210103,Position,Position,1)--伤害子弹
            self._proxy:LaunchMissileFromPosToPos(self._uuid,10210103,10210103,Position,Position,1)--伤害子弹
        elseif self._proxy:GetBuffStacks(self._uuid, 1016243) == 5 then
            self._proxy:LaunchMissileFromPosToPos(self._uuid,10210103,10210103,Position,Position,1)--伤害子弹
            self._proxy:LaunchMissileFromPosToPos(self._uuid,10210103,10210103,Position,Position,1)--伤害子弹
            self._proxy:LaunchMissileFromPosToPos(self._uuid,10210103,10210103,Position,Position,1)--伤害子弹
            self._proxy:LaunchMissileFromPosToPos(self._uuid,10210103,10210103,Position,Position,1)--伤害子弹
        elseif self._proxy:GetBuffStacks(self._uuid, 1016243) == 6 then
            self._proxy:LaunchMissileFromPosToPos(self._uuid,10210103,10210103,Position,Position,1)--伤害子弹
            self._proxy:LaunchMissileFromPosToPos(self._uuid,10210103,10210103,Position,Position,1)--伤害子弹
            self._proxy:LaunchMissileFromPosToPos(self._uuid,10210103,10210103,Position,Position,1)--伤害子弹
            self._proxy:LaunchMissileFromPosToPos(self._uuid,10210103,10210103,Position,Position,1)--伤害子弹
            self._proxy:LaunchMissileFromPosToPos(self._uuid,10210103,10210103,Position,Position,1)--伤害子弹
        elseif self._proxy:GetBuffStacks(self._uuid, 1016243) == 7 then
            self._proxy:LaunchMissileFromPosToPos(self._uuid,10210103,10210103,Position,Position,1)--伤害子弹
            self._proxy:LaunchMissileFromPosToPos(self._uuid,10210103,10210103,Position,Position,1)--伤害子弹
            self._proxy:LaunchMissileFromPosToPos(self._uuid,10210103,10210103,Position,Position,1)--伤害子弹
            self._proxy:LaunchMissileFromPosToPos(self._uuid,10210103,10210103,Position,Position,1)--伤害子弹

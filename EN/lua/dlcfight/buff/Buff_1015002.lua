...
---@class XBuffScript1015002 : XFightBase
local XBuffScript1015002 = XDlcScriptManager.RegBuffScript(1015002, "XBuffScript1015002", Base)

--效果说明：火属性伤害提升50%，每秒衰减5，最低0
function XBuffScript1015002:Init()
    --初始化
    Base.Init(self)
    ------------配置------------
    self.triggerCD = 1     --宝珠生效CD
    self.magicId = 1015003 --魔法id
...
function XBuffScript1015002:Update(dt)
    --每帧执行
    Base.Update(self, dt)
    ------------执行------------
...
function XBuffScript1015002:HandleEvent(eventType, eventArgs)
    Base.HandleEvent(self, eventType, eventArgs)
end

function XBuffScript1015002:Terminate()
    Base.Terminate(self)
end

return XBuffScript1015002

...
---@class XBuffScript10285090 : XTheatre6SkillBase
local XBuffScript10285090 = XDlcScriptManager.RegBuffScript(10285090, "XBuffScript10285090", XTheatre6SkillBase)

--效果说明：
--· 下一次使用技能后，返还消耗体力的20%。未实现。

function XBuffScript10285090:ScriptInit(isGainControl) --初始化
...
function XBuffScript10285090:OnLuaSkillStart(eventArgs)
    ------------执行------------

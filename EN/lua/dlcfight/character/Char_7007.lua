...
---重炮射击敌人脚本
---@class XCharHeavyArtillery7007 : XBigWorldCharBase
---@field _uuid number 当前脚本挂载的NpcId
---@field _proxy XDlcCSharpFuncs
local XCharHeavyArtillery7007 = XDlcScriptManager.RegCharScript(7007, "XCharHeavyArtillery7007", Base)

function XCharHeavyArtillery7007:CommonInit()
    Base.CommonInit(self)
    -- 自定义参数
    self._attackRange = 10 -- 进入攻击状态的范围
    self._attackSkillActionId = 700701 -- 攻击技能 id
...
function XCharHeavyArtillery7007:TryAttackPlayer(dt)
...
function XCharHeavyArtillery7007:HandleEvent(eventType, eventArgs)
end

function XCharHeavyArtillery7007:Terminate()
end

return XCharHeavyArtillery7007

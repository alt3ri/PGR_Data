...
--[[function XChar8053:AfterDamageCalc(eventArgs)   -- 计算伤害后
...
--------------------------------技能组逻辑---------------------------------------------
function XChar8053:JiGuangSkill3() --触手炼狱启动
...
function XChar8053:ChuShouLianYu() --触手炼狱
    local Target = self.PlayUUID[1]
    for i = 1,#self.PlayUUID, 1 do
...
function XChar8053:HandleLuaEvent(eventType, eventArgs)
    -- 响应AI开启和停止
...
function XChar8053:OnNpcBrokenAfter(launcherUUID, targetUUID, magicId)  --破韧
    local Target = self.PlayUUID[1]
    XLog.Warning("破韧成功")

local XRedPointConditionKoroCharActivity1 = {}
local SubCondition = nil
function XRedPointConditionKoroCharActivity1.GetSubConditions()
...
function XRedPointConditionKoroCharActivity1.Check()
...
return XRedPointConditionKoroCharActivity1
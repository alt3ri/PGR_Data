...
function XRpgMakerGameTriggerData:PlayTriggerStatusChangeAction(action, cb, isNotPlaySound)
    ...
    if triggerType == XMVCA.XRpgMakerGame.EnumConst.XRpgMakerGameTriggerType.Trigger2 then
        ...
        if not isNotPlaySound and self.StatusIsChange then
            XLuaAudioManager.PlayAudioByType(XLuaAudioManager.SoundType.SFX, XLuaAudioManager.UiBasicsMusic.RpgMakerGame_TriggerType2)
        end
    ...
    elseif triggerType == XMVCA.XRpgMakerGame.EnumConst.XRpgMakerGameTriggerType.TriggerElectricFence then
        ...
        if self.IsPlayElectricStatusSwitchSound and self.ElectricStatusIsChange then
            XLuaAudioManager.PlayAudioByType(XLuaAudioManager.SoundType.SFX, XLuaAudioManager.UiBasicsMusic.RpgMakerGame_ElectricStatusSwitch)
        end

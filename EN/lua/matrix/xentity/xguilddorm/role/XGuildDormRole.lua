...
function XGuildDormRole:BeginSpecialFurnitureInteract(interactInfo)
    local com = self:GetComponent("XGDFurnitureSpecialInteractComponent")
    if com == nil then return end
    com:BeginInteract(interactInfo, false)
end

function XGuildDormRole:BeginFurnitureRandomBoxInteract(interactInfo)
    local com = self:GetComponent("XGDFurnitureRandomBoxInteractComponent")
    if com == nil then return end
    XDataCenter.GuildDormManager.RequestGuildDormCallRandomBox(interactInfo.Id, function(data)
        com:BeginInteract(interactInfo, false, data)
    end, true)
end

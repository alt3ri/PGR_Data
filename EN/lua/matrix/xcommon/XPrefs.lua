...
XPrefs.WeekCardContinueBuy = "WEEK_CARD_CONTINUE_BUY"
...
-- 看板动作字幕显示设置
XPrefs.CaptionType = "CAPTION_TYPE"

-- 战斗震屏
XPrefs.FightCameraVibration = "FIGHT_CAMERA_VIBRATION"
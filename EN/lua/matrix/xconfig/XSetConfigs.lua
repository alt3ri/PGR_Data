...
local TABLE_CONTROLLER_TIPS_MAP_PATH = "Client/KeySet/UiControllerTipsGroupMap.tab"

local TABLE_INPUT_MAP_PATH = "Client/KeySet/InputMap.tab"
local ControllerMapTemplates = {}
local ControllerTipsMapTemplates = {}
---@type XTableInputMap[]
...
function XSetConfigs.Init()
    ...
    ControllerTipsMapTemplates = XTableManager.ReadByStringKey(TABLE_CONTROLLER_TIPS_MAP_PATH, XTable.XTableUiControllerTipsGroupMap, "UiName")
end
...
function XSetConfigs.GetControllerTipsMapCfg()
    return ControllerTipsMapTemplates
end

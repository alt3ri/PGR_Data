...
local TABLE_CHARACTER_ANIMA_SYNC_CALLBACK = "Client/Character/CharacterAnimaSyncCallBack.tab"

---@type XCharacterActionEffectTemplate[][][]
local EffectDictionary = {}
local EquipEffectDict = {}
local CharacterAnimaSyncCallBackDict = {}
...
function XCharacterUiEffectConfig.Init()
    ...
    CharacterAnimaSyncCallBackDict = XTableManager.ReadByStringKey(TABLE_CHARACTER_ANIMA_SYNC_CALLBACK, XTable.XTableCharacterAnimaSyncCallBack, "ModelName")

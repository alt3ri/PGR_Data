...
local TableKey = {
    ...
    SGCafeChapter = { CacheType = XConfigUtil.CacheType.Normal, ReadFunc = XConfigUtil.ReadType.IntAll },
...
function XSkyGardenCafeConfig:GetChapterName(chapterId)
    ---@type XTableSGCafeChapter
    local t = self._ConfigUtil:GetCfgByTableKeyAndIdKey(TableKey.SGCafeChapter, chapterId)
...
function XSkyGardenCafeConfig:GetCustomerDefaultNum(id)
    local t = self:GetCustomerTemplate(id)
    return t and t.DefaultNum or 0
end

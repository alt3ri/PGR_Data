...
---
--- 获得战前剧情ID对应的StageId
function XFubenConfigAgency:GetStageIdByBeginStoryId(storyId)
    return self._Model:GetStageIdByBeginStoryId(storyId)
end
...
function XFubenConfigAgency:GetSecondTagNumCustomParam(id, index)
    ---@type XTableFubenSecondTag
    local tagCfg = self:GetSecondTagConfigById(id)

    if tagCfg then
        if not string.IsNilOrEmpty(tagCfg.CustomParams[index]) and string.IsFloatNumber(tagCfg.CustomParams[index]) then
            return tonumber(tagCfg.CustomParams[index])
        end
    end
...
function XFubenConfigAgency:GetChallengeGridShowConditionList()
    return self._Model:GetChallengeGridShowConditionList()
end
...
function XFubenConfigAgency:GetFubenActivityConfigs()
    return self._Model:GetFubenActivityConfigs()
end

function XFubenConfigAgency:GetFubenTabConfig()
    return self._Model:GetFubenTabConfig()
end

function XFubenConfigAgency:GetFubenSecondTag()
    return self._Model:GetFubenSecondTag()
end

function XFubenConfigAgency:GetFubenStoryLine()
    return self._Model:GetFubenStoryLine()
end

function XFubenConfigAgency:GetFubenActivityTimeTips()
    return self._Model:GetFubenActivityTimeTips()
end

function XFubenConfigAgency:GetFubenCollegeBanner()
    return self._Model:GetFubenCollegeBanner()
end

function XFubenConfigAgency:GetFubenClientConfig()
    return self._Model:GetFubenClientConfig()
end

function XFubenConfigAgency:GetStageVoiceTip()
    return self._Model:GetStageVoiceTip()
end

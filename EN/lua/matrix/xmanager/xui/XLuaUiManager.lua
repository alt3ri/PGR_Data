...
function XLuaUiManager.CloseAllUpperUi(uiName)
    XLuaUiManager._CloseAllUpperUi(uiName)
end
...
function XLuaUiManager.CloseAllUpperUiWithCallback(uiName, callback)
    XLuaUiManager._CloseAllUpperUi(uiName, callback)
end

function XLuaUiManager._CloseAllUpperUi(uiName, callback)
...
function XLuaUiManager.IsStackUiOpen(uiName)
    return CsXUiManager.Instance:IsStackUiOpen(uiName)
end

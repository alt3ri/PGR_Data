...
XAchievementManagerCreator = function()
    ...
    function XAchievementManager.GetTaskByTaskId(taskId)
        ...
        local taskType = XTaskConfig.GetTaskType(task.Id)
        if taskType ~= XDataCenter.TaskManager.TaskType.Achievement then
            return false
        end
        return task
    end
    ...
    function XAchievementManager.GetTaskStateByTaskId(taskId)
        ...
        local task = XAchievementManager.GetTaskByTaskId(taskId)

...
---@class XUiGridGachaLuciaShowReward : XUiNode
---@field Parent XUiGachaLuciaShow
local XUiGridGachaLuciaShowReward = XClass(XUiNode, "XUiGridGachaLuciaShowReward")
...
function XUiGridGachaLuciaShowReward:OnStart(uiPanel, farCamera, nearCamera, uiCamera)
...
function XUiGridGachaLuciaShowReward:InitUiObject()
...
function XUiGridGachaLuciaShowReward:OnShow(rewardInfo)
...
function XUiGridGachaLuciaShowReward:OnShowEnd()
...
function XUiGridGachaLuciaShowReward:CreateModel(id, rewardType)
...
function XUiGridGachaLuciaShowReward:CreateWeaponModel(templateId)
...
function XUiGridGachaLuciaShowReward:CreateWeaponFashionModel(templateId)
...
function XUiGridGachaLuciaShowReward:CreateCharacterModel(templateId, fashionId)
...
function XUiGridGachaLuciaShowReward:CreatePartnerModel(templateId)
...
function XUiGridGachaLuciaShowReward:CreateItem(iconPath, isSmall, type)
...
function XUiGridGachaLuciaShowReward:LoadEffect(id)
    -- 加载底座特效
...
-- 加载3d 通讯线特效
function XUiGridGachaLuciaShowReward:Load3dLineEffect(model, effectKey)
...
function XUiGridGachaLuciaShowReward:OnDestroy()
    
end

return XUiGridGachaLuciaShowReward
---@class XUiGridGachaLuciaStageItem : XUiNode
---@field Parent XUiGachaLuciaStageLine
local XUiGridGachaLuciaStageItem = XClass(XUiNode, "XUiGridGachaLuciaStageItem")

function XUiGridGachaLuciaStageItem:SetNormalStage()
...
function XUiGridGachaLuciaStageItem:SetPassStage()
    self.PanelStagePass.gameObject:SetActiveEx(self._FStage:GetIsPass())
end

function XUiGridGachaLuciaStageItem:UpdateNode(index, festivalId, stageId)
...
function XUiGridGachaLuciaStageItem:OnBtnStageClick()
...
function XUiGridGachaLuciaStageItem:SetNodeSelect(isSelect)
    if not self._IsLock and self.ImageSelected then
        self.ImageSelected.gameObject:SetActiveEx(isSelect)
    end
end

function XUiGridGachaLuciaStageItem:ResetItemPosition(pos)
    if self.ImgHideLine then
...
return XUiGridGachaLuciaStageItem
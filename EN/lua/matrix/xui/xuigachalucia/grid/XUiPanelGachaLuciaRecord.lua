---@class XUiPanelGachaLuciaRecord : XUiNode
---@field Parent XUiGachaLuciaLog
local XUiPanelGachaLuciaRecord = XClass(XUiNode, "XUiPanelGachaLuciaRecord")

function XUiPanelGachaLuciaRecord:OnStart()
    self._TypeText = {}
    self:SetTypeText()
end

function XUiPanelGachaLuciaRecord:SetTypeText()
...
function XUiPanelGachaLuciaRecord:RefreshUiShow(gachaConfig)
...
function XUiPanelGachaLuciaRecord:SetLogData(name, templateId, from, time, quality)
...
return XUiPanelGachaLuciaRecord
...
---@class XUiGachaLuciaTip : XLuaUi
local XUiGachaLuciaTip = XLuaUiManager.Register(XLuaUi, "UiGachaLuciaTip")

local type = type

function XUiGachaLuciaTip:OnAwake()
    self:InitAutoScript()
end

function XUiGachaLuciaTip:OnStart(data, hideSkipBtn, rootUiName, lackNum, showNum, switchRainbowCard, title, isShowCount)
...
function XUiGachaLuciaTip:OnEnable()
    self:Refresh(self.Data)
end

function XUiGachaLuciaTip:OnDisable()

end

function XUiGachaLuciaTip:OnDestroy()

end

function XUiGachaLuciaTip:ShowCurrentRainbowCard()
...
function XUiGachaLuciaTip:InitAutoScript()
    self.SpecialSoundMap = {}
    self:AutoAddListener()
end

function XUiGachaLuciaTip:GetAutoKey(uiNode, eventName)
    if not uiNode then
        return
    end
...
function XUiGachaLuciaTip:RegisterListener(uiNode, eventName, func)
...
function XUiGachaLuciaTip:AutoAddListener()
...
-- auto
function XUiGachaLuciaTip:OnBtnBackClick()
    self:Close()
end

function XUiGachaLuciaTip:OnBtnGetClick()
    XLuaUiManager.Open("UiSkip", self.TemplateId, function()
        self:Close()
    end, self.HideSkipBtn)
end

function XUiGachaLuciaTip:OnBtnOkClick()
    self:Close()
end

function XUiGachaLuciaTip:OnBtnTcanchaungBlackClick()
...
function XUiGachaLuciaTip:OnBtnActionClick()
...
function XUiGachaLuciaTip:SetUiActive(ui, active)
...
function XUiGachaLuciaTip:ResetUi()
...
function XUiGachaLuciaTip:Refresh(data)
    self.Data = data
    if not data then
...
--===============
function XUiGachaLuciaTip:SetTempData(data)
    -- 名称
...
function XUiGachaLuciaTip:OnGetEvents()
    return {
        XEventId.EVENT_ITEM_FAST_TRADING
    }
end

function XUiGachaLuciaTip:OnNotify(evt, ...)

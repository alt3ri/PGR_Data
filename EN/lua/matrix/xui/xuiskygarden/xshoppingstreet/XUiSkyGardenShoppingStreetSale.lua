...
function XUiSkyGardenShoppingStreetSale:SelectTagByIndex(index)
    ...
    XMVCA.XSkyGardenShoppingStreet:SetPromotionSelectType(data.Type)
...
function XUiSkyGardenShoppingStreetSale:OnDestroy()
    XMVCA.XSkyGardenShoppingStreet:SetPromotionSelectType(0)
end
--endregion

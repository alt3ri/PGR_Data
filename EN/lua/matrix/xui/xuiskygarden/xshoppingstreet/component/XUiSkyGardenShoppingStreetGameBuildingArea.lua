...
function XUiSkyGardenShoppingStreetGameBuildingArea:ShowShopCoinEffect(areaId)
    if areaId > self._insideCount then
        self._OutSideBuildings[areaId - self._insideCount]:ShowCoinEffect()
    else
        self._InSideBuildings[areaId]:ShowCoinEffect()
    end
end
...
function XUiSkyGardenShoppingStreetGameBuildingArea:UpdateAllShop()
    for i = 1, self._insideCount do
        self._InSideBuildings[i]:RefreshBuilding()
    end
    for i = 1, self._outsideCount do

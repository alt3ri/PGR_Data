...
function XUiPanelSGGiftWall:OnSelectFurniture(id, cfgId, isCreate, isAlbumPhoto)
    ...
    if majorType == SgFurnitureType.Gift then
        ...
        local isPut = false
        local putFurniture = data:GetFurniture(id, isAlbumPhoto)
...
function XUiPanelSGGiftWall:OnCreateGift(id, cfgId)
    ...
    self._Control:AddFightFurnitureData(id, data, self._SelectPosIndex + 1, false)

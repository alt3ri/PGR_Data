...
---@class XUiGachaSelenaStageDetail : XLuaUi
local XUiGachaSelenaStageDetail = XLuaUiManager.Register(XLuaUi, "UiGachaSelenaStageDetail")

function XUiGachaSelenaStageDetail:OnAwake()
    ---@type XUiGridCommon[]
    self._GridList = {}
...
function XUiGachaSelenaStageDetail:OnStart(stageId)
...
function XUiGachaSelenaStageDetail:OnEnable()
...
function XUiGachaSelenaStageDetail:PlayStoryId(movieId)
    XDataCenter.MovieManager.PlayMovie(movieId)
end

function XUiGachaSelenaStageDetail:OnBtnEnterClick()
    local stageCfg = self._StageCfg
...
return XUiGachaSelenaStageDetail
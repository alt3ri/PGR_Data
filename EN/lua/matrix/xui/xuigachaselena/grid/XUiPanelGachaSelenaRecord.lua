---@class XUiPanelGachaSelenaRecord : XUiNode
---@field Parent XUiGachaSelenaLog
local XUiPanelGachaSelenaRecord = XClass(XUiNode, "XUiPanelGachaSelenaRecord")

function XUiPanelGachaSelenaRecord:OnStart()
    self._TypeText = {}
    self:SetTypeText()
end

function XUiPanelGachaSelenaRecord:SetTypeText()
    ...
    self._TypeText[XArrangeConfigs.Types.Background] = CS.XTextManager.GetText("TypeBackground")
end

function XUiPanelGachaSelenaRecord:RefreshUiShow(gachaConfig)
...
function XUiPanelGachaSelenaRecord:SetLogData(name, templateId, from, time, quality)
...
return XUiPanelGachaSelenaRecord
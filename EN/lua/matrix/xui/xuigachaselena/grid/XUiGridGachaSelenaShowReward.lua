...
---@class XUiGridGachaSelenaShowReward : XUiNode
---@field Parent XUiGachaSelenaShow
local XUiGridGachaSelenaShowReward = XClass(XUiNode, "XUiGridGachaSelenaShowReward")
...
function XUiGridGachaSelenaShowReward:OnStart(uiPanel, farCamera, nearCamera, uiCamera)
...
function XUiGridGachaSelenaShowReward:InitUiObject()
...
function XUiGridGachaSelenaShowReward:OnShow(rewardInfo)
...
function XUiGridGachaSelenaShowReward:OnShowEnd()
...
function XUiGridGachaSelenaShowReward:CreateModel(id, rewardType)
...
function XUiGridGachaSelenaShowReward:CreateWeaponModel(templateId)
...
function XUiGridGachaSelenaShowReward:CreateWeaponFashionModel(templateId)
...
function XUiGridGachaSelenaShowReward:CreateCharacterModel(templateId, fashionId)
...
function XUiGridGachaSelenaShowReward:CreatePartnerModel(templateId)
...
function XUiGridGachaSelenaShowReward:CreateItem(iconPath, isSmall, type)
...
function XUiGridGachaSelenaShowReward:LoadEffect(id)
    -- 加载底座特效
...
return XUiGridGachaSelenaShowReward
---@class XUiGachaSelenaTip : XLuaUi
local XUiGachaSelenaTip = XLuaUiManager.Register(XLuaUi, "UiGachaSelenaTip")

local type = type

function XUiGachaSelenaTip:OnAwake()
    self:InitAutoScript()
end

function XUiGachaSelenaTip:OnStart(data, hideSkipBtn, rootUiName, lackNum, showNum, switchRainbowCard, title, isShowCount)
...
function XUiGachaSelenaTip:OnEnable()
    self:Refresh(self.Data)
end

function XUiGachaSelenaTip:OnDisable()

end

function XUiGachaSelenaTip:OnDestroy()

end

function XUiGachaSelenaTip:ShowCurrentRainbowCard()
...
function XUiGachaSelenaTip:InitAutoScript()
    self.SpecialSoundMap = {}
    self:AutoAddListener()
end

function XUiGachaSelenaTip:GetAutoKey(uiNode, eventName)
    if not uiNode then
        return
    end
...
function XUiGachaSelenaTip:RegisterListener(uiNode, eventName, func)
...
function XUiGachaSelenaTip:AutoAddListener()
...
-- auto
function XUiGachaSelenaTip:OnBtnBackClick()
    self:Close()
end

function XUiGachaSelenaTip:OnBtnGetClick()
    XLuaUiManager.Open("UiSkip", self.TemplateId, function()
        self:Close()
    end, self.HideSkipBtn)
end

function XUiGachaSelenaTip:OnBtnOkClick()
    self:Close()
end

function XUiGachaSelenaTip:OnBtnTcanchaungBlackClick()
...
function XUiGachaSelenaTip:OnBtnActionClick()
...
function XUiGachaSelenaTip:SetUiActive(ui, active)
...
function XUiGachaSelenaTip:ResetUi()
...
function XUiGachaSelenaTip:Refresh(data)
    self.Data = data
    if not data then
...
--===============
function XUiGachaSelenaTip:SetTempData(data)
    -- 名称
...
function XUiGachaSelenaTip:OnGetEvents()
    return {
        XEventId.EVENT_ITEM_FAST_TRADING
    }
end

function XUiGachaSelenaTip:OnNotify(evt, ...)

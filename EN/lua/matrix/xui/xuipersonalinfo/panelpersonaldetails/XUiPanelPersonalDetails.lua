...
function XUiPanelPersonalDetails:InitData()
    self.BtnSlider = self.Transform:Find("ImgJBLevelBg/Slider"):GetComponent(typeof(CS.UnityEngine.UI.Slider))
...
function XUiPanelPersonalDetails:AutoInitUi()
    self.TxtIdcode = self.Transform:Find("TxtIdcode"):GetComponent(typeof(CS.UnityEngine.UI.Text))
    self.BtnCopy = self.Transform:Find("TxtIdcode/BtnCopy"):GetComponent(typeof(CS.UnityEngine.UI.Button))
    self.TxtLevel = self.Transform:Find("TxtLevel"):GetComponent(typeof(CS.UnityEngine.UI.Text))
    ...
    self.TxtBirthday = self.Transform:Find("TxtBirthday"):GetComponent(typeof(CS.UnityEngine.UI.Text))
    self.ImgJBLevelBg = self.Transform:Find("ImgJBLevelBg"):GetComponent(typeof(CS.UnityEngine.UI.Image))
    self.TxtJBLevel = self.Transform:Find("ImgJBLevelBg/TxtJBLevel"):GetComponent(typeof(CS.UnityEngine.UI.Text))
    self.TxtJBPercent = self.Transform:Find("ImgJBLevelBg/TxtJBPercent"):GetComponent(typeof(CS.UnityEngine.UI.Text))
    self.Slider = self.Transform:Find("ImgJBLevelBg/Slider"):GetComponent(typeof(CS.UnityEngine.UI.Slider))
    self.BtnViewJb = self.Transform:Find("ImgJBLevelBg/BtnView"):GetComponent(typeof(CS.UnityEngine.UI.Button))
    self.ImgTeamBg = self.Transform:Find("ImgTeamBg"):GetComponent(typeof(CS.UnityEngine.UI.Image))
    self.TxtTeamName = self.Transform:Find("ImgTeamBg/TxtTeamName"):GetComponent(typeof(CS.UnityEngine.UI.Text))
    self.BtnViewTeam = self.Transform:Find("ImgTeamBg/BtnView"):GetComponent(typeof(CS.UnityEngine.UI.Button))
    self.BtnContent = self.Transform:Find("BtnContent"):GetComponent(typeof(CS.UnityEngine.UI.Button))
    self.BtnDormitory = self.Transform:Find("BtnContent/BtnDormitory"):GetComponent(typeof(CS.UnityEngine.UI.Button))
    self.BtnDormitoryDis = self.Transform:Find("BtnContent/BtnDormitoryDis")
    self.BtnPrivateChat = self.Transform:Find("BtnContent/BtnPrivateChat"):GetComponent(typeof(CS.UnityEngine.UI.Button))
    self.BtnAssistance = self.Transform:Find("BtnContent/BtnAssistance"):GetComponent(typeof(CS.UnityEngine.UI.Button))
    self.BtnAssistanceDis = self.Transform:Find("BtnContent/BtnAssistanceDis")
    self.BtnDelete = self.Transform:Find("BtnContent/BtnDelete"):GetComponent(typeof(CS.UnityEngine.UI.Button))
    self.BtnAdd = self.Transform:Find("BtnContent/BtnAdd"):GetComponent(typeof(CS.UnityEngine.UI.Button))
    self.BtnReport = self.Transform:Find("BtnContent/BtnReport"):GetComponent(typeof(CS.UnityEngine.UI.Button))
    self.BtnPraise = self.Transform:Find("BtnContent/BtnPraise"):GetComponent(typeof(CS.UnityEngine.UI.Button))
    self.TxtCount = self.Transform:Find("BtnContent/BtnPraise/TxtCount"):GetComponent(typeof(CS.UnityEngine.UI.Text))
...
function XUiPanelPersonalDetails:RegisterListener(uiNode, eventName, func)
    ...
    if func ~= nil then
        if type(func) ~= "function" then
            XLog.Error("XUiPanelPersonalDetails:RegisterListener函数错误, 参数func需要是function类型, func的类型是" .. type(func))
        end

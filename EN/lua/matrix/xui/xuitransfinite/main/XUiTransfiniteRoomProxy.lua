...
function XUiTransfiniteRoomProxy:AOPOnStartAfter(ui)
    ...
    local isShowTeam = stageGroup:IsBegin() and stageGroup:GetCurrentIndex() > stageGroup:GetStartStageProgress()
    ui.BtnTeamPrefab.gameObject:SetActiveEx(not isShowTeam)
end

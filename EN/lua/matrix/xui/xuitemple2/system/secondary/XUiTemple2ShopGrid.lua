...
---@class XUiTemple2ShopGrid : XUiGridShop
local XUiTemple2ShopGrid = XClass(XUiGridShop, "XUiTemple2ShopGrid")

---@param parent XUiTemple2Shop
--function XUiTemple2ShopGrid:Init(parent, rootUi, uiParams)
--    XUiGridShop.Init(self, parent, rootUi, uiParams)
--    local haveBuyCountColor = "ffd070"
--    local notBuyCountColor = "ffd070"
--    --if notBuyCountColor then
--    --    self.TxtLimitLock.color = XUiHelper.Hexcolor2Color(notBuyCountColor)
--    --end
--    --if haveBuyCountColor then
--    --    self.TxtLimitNormal.color = XUiHelper.Hexcolor2Color(haveBuyCountColor)
--    --end
--end

---购买次数
--function XUiTemple2ShopGrid:RefreshBuyCount()
...
---购买状态
--function XUiTemple2ShopGrid:RefreshShowLock()
...
--    end
--    if self.TxtPriceLock then
--        self.TxtPriceLock.gameObject:SetActiveEx(isLock)
--    end
--    if self.TxtLimitLock then
--        self.TxtLimitLock.gameObject:SetActiveEx(isLock)
--    end
--
...
---货币数量及图标
--function XUiTemple2ShopGrid:RefreshPrice()
...
--
-----重载：条件判断
--function XUiTemple2ShopGrid:RefreshCondition()
...
--
-----重载：售罄状态刷新
--function XUiTemple2ShopGrid:RefreshSellOut()

...
function XUiCharacterSystemV2P6:InitModel()
    ...
    self.RoleModelPanel2 = XUiPanelRoleModel.New(self.PanelModel.PanelRoleModel2, nil, nil, true, nil, true)
end
...
function XUiCharacterSystemV2P6:RefreshRoleModel2(characterId, cb)
    if not characterId then
        return
    end

    self.RoleModelPanel2:UpdateCharacterModel(characterId, self.PanelRoleModel, nil, cb)
end

function XUiCharacterSystemV2P6:SetRoleModelPanelActive(flag)
    self.PanelModel.PanelRoleModel.gameObject:SetActiveEx(flag)
end

function XUiCharacterSystemV2P6:SetRoleModelPanel2Active(flag)
    self.PanelModel.PanelRoleModel2.gameObject:SetActiveEx(flag)
end

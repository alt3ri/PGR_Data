...
local ComeAcrossEliminateGamePlayer = XClass(ComeAcrossGamePlayer, "ComeAcrossEliminateGamePlayer")
...
function ComeAcrossEliminateGamePlayer:OnPlayerInit()
    ...
    ComeAcrossEliminateGamePlayer.Super.OnPlayerInit(self)
end

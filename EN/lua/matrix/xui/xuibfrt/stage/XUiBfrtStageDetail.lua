...
---@class XUiBfrtStageDetail:XLuaUi
...
function XUiBfrtStageDetail:OnBtnEnterClick()
    ...
    local groupId = XDataCenter.BfrtManager.GetGroupIdByBaseStage(self.BaseStageId)
    local fun = function()
        self:_OnBtnEnterClick()
    end
    if XDataCenter.BfrtManager.CheckAndDialogGroupStageRecord(groupId, fun) then
        return
    end
...
function XUiBfrtStageDetail:_OnBtnEnterClick()

...
function XUiGuildDormMusicPlayer:OnStart()
    ...
    self.RoundEffectEnable = self:FindTransform("RoundEffectEnable"):GetComponent(typeof(CS.UnityEngine.Playables.PlayableDirector))
    self.RoundEffectLoop = self:FindTransform("RoundEffectLoop"):GetComponent(typeof(CS.UnityEngine.Playables.PlayableDirector))
    self.EffectLoop = self:FindTransform("EffectLoop"):GetComponent(typeof(CS.UnityEngine.Playables.PlayableDirector))
    self.EffectEnable = self:FindTransform("EffectEnable"):GetComponent(typeof(CS.UnityEngine.Playables.PlayableDirector))
    self:UpdateSpectrum()

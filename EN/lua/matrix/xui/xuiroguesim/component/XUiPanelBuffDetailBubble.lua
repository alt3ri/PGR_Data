...
function XUiPanelBuffDetailBubble:SetInfo(info)
    self.CurAlignment = info and info.Alignment or XEnumConst.RogueSim.Alignment.RTB
    self:SetAnchorAndPivot()
end

function XUiPanelBuffDetailBubble:Refresh(targetTransform, info)
    self:SetInfo(info)

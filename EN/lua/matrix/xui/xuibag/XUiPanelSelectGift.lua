...
function XUiPanelSelectGift:Refresh(id)
    ...
    XUiHelper.CreateTemplates(self.RootUi, self.RewardItems, self.GridDatas, XUiGridSelectGift.New, self.GridRewardItem.gameObject, self.PanelReward, onCreate)
...
function XUiPanelSelectGift:OpenDetailUi(data)
...
function XUiPanelSelectGift:HandleConfirmClick(itemId ,rewardIds, rewardHasOwnTypeList)
...
function XUiPanelSelectGift:OnBtnClearSelectionClick()
    for _, index in pairs(self.SelectGridIndexs)do

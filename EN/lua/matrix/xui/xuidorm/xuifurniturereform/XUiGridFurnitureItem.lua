...
function XUiGridFurnitureItem:CheckTouch(eventData)
    ...
    if template.PetId > 0 and XHomeDormManager.CheckFurnitureCountReachLimitByPet(self.RoomId) then
        XUiManager.TipText("FurniturePetOutOfLimit")
        return false
    end
...
function XUiGridFurnitureItem:RefreshLabel()
    ...
    local templateId = self.FurnitureData.ConfigId

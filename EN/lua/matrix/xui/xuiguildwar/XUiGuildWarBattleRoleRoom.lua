...
---@overload
function XUiGuildWarBattleRoleRoom:GetValidEntityIdList(stageId, team)
    --公会战队伍数据非通用，且有自己的剔除规则，屏蔽通用剔除逻辑
    return nil
end

function XUiGuildWarBattleRoleRoom:CheckShowAnimationSet()
    return false
end

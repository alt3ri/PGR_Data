local XUiGuildWarReinforceRankGrid = XClass(nil, 'XUiGuildWarReinforceRankGrid')

function XUiGuildWarReinforceRankGrid:Ctor(uiPrefab)
...
function XUiGuildWarReinforceRankGrid:RefreshData(data, isStay)
...
return XUiGuildWarReinforceRankGrid
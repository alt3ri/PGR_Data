local XUiGridFuncUpgradeInfoItem = XClass(nil, "XUiGridFuncUpgradeInfoItem")
...
function XUiGridFuncUpgradeInfoItem:RegisterListener(uiNode, eventName, func)
    ...
    if func ~= nil then
        if type(func) ~= "function" then
            XLog.Error("XUiGridFuncUpgradeInfoItem:RegisterListener函数错误, 参数func需要是function类型, func的类型是" .. type(func))
        end
...
return XUiGridFuncUpgradeInfoItem
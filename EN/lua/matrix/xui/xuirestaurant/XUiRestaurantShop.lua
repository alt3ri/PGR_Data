...
---@class XUiRestaurantShop : XLuaUi
...
function XUiRestaurantShop:OnAwake()
    ...
    self.ShopItemTextColor.CanBuyColor = self._Control:GetShopBuyTxtColor(1)
    self.ShopItemTextColor.CanNotBuyColor = self._Control:GetShopBuyTxtColor(2)
...
function XUiRestaurantShop:OnDestroy()
    self._Control:SendEvent(XMVCA.XRestaurant.EventId.OnShopUiClose)
end

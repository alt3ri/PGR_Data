---@class XUiPanelGachaAlphaRecord : XUiNode
---@field Parent XUiGachaAlphaLog
local XUiPanelGachaAlphaRecord = XClass(XUiNode, "XUiPanelGachaAlphaRecord")

function XUiPanelGachaAlphaRecord:OnStart()
    self._TypeText = {}
    self:SetTypeText()
end

function XUiPanelGachaAlphaRecord:SetTypeText()
...
function XUiPanelGachaAlphaRecord:RefreshUiShow(gachaConfig)
...
function XUiPanelGachaAlphaRecord:SetLogData(name, templateId, from, time, quality)
...
return XUiPanelGachaAlphaRecord
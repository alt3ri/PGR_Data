...
---@class XUiGridGachaAlphaShowReward : XUiNode
---@field Parent XUiGachaAlphaShow
local XUiGridGachaAlphaShowReward = XClass(XUiNode, "XUiGridGachaAlphaShowReward")
...
function XUiGridGachaAlphaShowReward:OnStart(uiPanel, farCamera, nearCamera, uiCamera)
...
function XUiGridGachaAlphaShowReward:InitUiObject()
...
function XUiGridGachaAlphaShowReward:OnShow(rewardInfo)
...
function XUiGridGachaAlphaShowReward:OnShowEnd()
...
function XUiGridGachaAlphaShowReward:CreateModel(id, rewardType)
...
function XUiGridGachaAlphaShowReward:CreateWeaponModel(templateId)
...
function XUiGridGachaAlphaShowReward:CreateWeaponFashionModel(templateId)
...
function XUiGridGachaAlphaShowReward:CreateCharacterModel(templateId, fashionId)
...
function XUiGridGachaAlphaShowReward:CreatePartnerModel(templateId)
...
function XUiGridGachaAlphaShowReward:CreateItem(iconPath, isSmall, type)
...
function XUiGridGachaAlphaShowReward:LoadEffect(id)
    -- 加载底座特效
...
-- 加载3d 通讯线特效
function XUiGridGachaAlphaShowReward:Load3dLineEffect(model, effectKey)
...
function XUiGridGachaAlphaShowReward:OnDestroy()
    
end

return XUiGridGachaAlphaShowReward
...
function XUiFubenKoroStageItem:Ctor(rootUi, ui)
...
function XUiFubenKoroStageItem:UpdateNode(id, stageId, stageIndex, panelType)
    self.Id = id
...
function XUiFubenKoroStageItem:SetNormalStage()
...
function XUiFubenKoroStageItem:OnBtnStageClick()
...
--显示选中框
function XUiFubenKoroStageItem:SetNodeSelect(isSelect)
    if self.IsOpen then
        self.ImageSelected.gameObject:SetActiveEx(isSelect)
    end
end

return XUiFubenKoroStageItem
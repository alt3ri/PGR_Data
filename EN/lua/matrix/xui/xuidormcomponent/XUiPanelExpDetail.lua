local XUiPanelExpDetail = XClass(XLuaBehaviour, "XUiPanelExpDetail")
...
function XUiPanelExpDetail:InitAddListen()
    ...
    XEventManager.AddEventListener(XEventId.EVENT_DORM_HEAD_TOUCH, self.OnBtnTouchClickCb, self)
end

function XUiPanelExpDetail:OnDestroy()
    XEventManager.RemoveEventListener(XEventId.EVENT_DORM_HEAD_TOUCH, self.OnBtnTouchClickCb, self)
end

---@class XUiGachaLamiyaPassport : XLuaUi 使用皮肤和场景弹框
local XUiGachaLamiyaPassport = XLuaUiManager.Register(XLuaUi, "UiGachaLamiyaPassport")

function XUiGachaLamiyaPassport:OnAwake()
...
function XUiGachaLamiyaPassport:OnStart(reward, callBack)
    ...
    self.BtnWear:SetNameByGroup(0, XUiHelper.GetText(self._IsBackGround and "GachaLamiyaBgBtn" or "GachaLamiyaFashionBtn"))
...
function XUiGachaLamiyaPassport:Close()
...
function XUiGachaLamiyaPassport:OnWear()
...
function XUiGachaLamiyaPassport:OnSetAssistant()
    self.BtnSetAssistant.gameObject:SetActiveEx(false)

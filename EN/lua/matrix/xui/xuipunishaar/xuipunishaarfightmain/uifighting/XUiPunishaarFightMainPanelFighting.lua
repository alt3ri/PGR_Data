...
function XUiPunishaarFightMainPanelFighting:OnEnable()
    ...
    gameControl:AddEventListener(gameControl.EventIds.EnemyAttackPrepare, self._OnEnemyAttackPrepare, self)  -- 敌人准备攻击→FxEnemyAttack 特效 #EnemyAttack
...
function XUiPunishaarFightMainPanelFighting:OnDisable()
    ...
    if gameControl then
        ...
        gameControl:RemoveEventListener(gameControl.EventIds.EnemyAttackPrepare, self._OnEnemyAttackPrepare, self)
...
--- 敌人准备攻击回调（EnemyAttackPrepare 事件）→ PanelEnemyHp FxEnemyAttack 特效重播 #EnemyAttack
function XUiPunishaarFightMainPanelFighting:_OnEnemyAttackPrepare()
    if self.PanelEnemyHp then
        self.PanelEnemyHp:PlayFxEnemyAttack()
    end
end

---@class XUiPanelGachaBiankaRule : XUiNode
---@field Parent XUiGachaBiankaLog
local XUiPanelGachaBiankaRule = XClass(XUiNode, "XUiPanelGachaBiankaRule")

function XUiPanelGachaBiankaRule:RefreshUiShow(gachaConfig)
...
return XUiPanelGachaBiankaRule
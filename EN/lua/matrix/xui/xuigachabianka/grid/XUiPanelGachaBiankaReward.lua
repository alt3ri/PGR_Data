...
---@class XUiPanelGachaBiankaReward : XUiNode
---@field Parent XUiGachaBiankaLog
local XUiPanelGachaBiankaReward = XClass(XUiNode, "XUiPanelGachaBiankaReward")

function XUiPanelGachaBiankaReward:RefreshUiShow(gachaConfig)
...
return XUiPanelGachaBiankaReward
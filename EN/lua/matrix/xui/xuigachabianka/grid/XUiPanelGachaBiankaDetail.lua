...
---@class XUiPanelGachaBiankaDetail : XUiNode
---@field Parent XUiGachaBiankaLog
local XUiPanelGachaBiankaDetail = XClass(XUiNode, "XUiPanelGachaBiankaDetail")

function XUiPanelGachaBiankaDetail:RefreshUiShow(gachaConfig)
...
return XUiPanelGachaBiankaDetail
...
function XUiGuardCampMain:InitUi()
    self.PanelBtnYilingquDetail = XUiHelper.TryGetComponent(self.Transform, "SafeAreaContentPane/PanelBtnYilingquDetail")
end
...
function XUiGuardCampMain:Refresh()
    ...
    self.PanelBtnLingquDetail.gameObject:SetActiveEx(isSelectCamp and state == XGuardCampConfig.ActivityState.DrawLottery and not isGetReward)
    self.PanelBtnYilingquDetail.gameObject:SetActiveEx(isGetReward)

...
local XUiBigWorldStoryStageDetail = XMVCA.XBigWorldUI:Register(nil, "UiBigWorldStoryStageDetail")
...
function XUiBigWorldStoryStageDetail:InitView()
    ...
    local desc = ""
    if state == QuestState.Ready then

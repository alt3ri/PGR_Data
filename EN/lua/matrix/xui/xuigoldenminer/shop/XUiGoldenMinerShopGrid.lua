...
function XUiGoldenMinerShopGrid:SetCanvasGroupAlpha(value)
    if self.CanvasGroup then
        self.CanvasGroup.alpha = value
    end
end

function XUiGoldenMinerShopGrid:PlayAnimationRefresh()
    if self.GridShopEnable then
        self.GridShopEnable:PlayTimelineAnimation()
    end
end
--endregion

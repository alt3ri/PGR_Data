...
function XUiRiftPluginFilterTips:OnStart(setting, closeCb)
    ...
    local setting = self._Control:GetFilterSertting(setting)
    ...
    local configs = self._Control:GetRiftFilterTagConfigs()
...
function XUiRiftPluginFilterTips:OnBtnFilterClick()
    self._Control:SaveFilterSertting(self._Setting, self._FilterData)
    self:OnClickClose()
end

function XUiRiftPluginFilterTips:OnBtnClearTagClick()
    self._Control:SaveFilterSertting(self._Setting)
    self:OnClickClose()
end

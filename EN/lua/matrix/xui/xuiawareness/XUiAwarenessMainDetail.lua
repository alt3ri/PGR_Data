...
function XUiAwarenessMainDetail:Refresh()
    self.BaseStageId = self.ChapterData:GetBaseStageId()
    self.StageData = XDataCenter.FubenManager.GetStageData(self.BaseStageId)
    self.StageCfg = XDataCenter.FubenManager.GetStageCfg(self.BaseStageId)
